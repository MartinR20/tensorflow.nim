...
{.compile:"../../ops/data/data.cc".}


type BatchDataset* {.header:"../../ops/data/data.h", importcpp:"BatchDataset/*'0*/".} = object
...
proc iibatchDataset(scope: Scope,
                   ...
                   output_shapes: ArraySlice[TensorShape]): BatchDataset {.header:"../../ops/data/data.h", importcpp:"BatchDataset(*#, #, #, #, #)", constructor.}
...
type BatchDatasetV2* {.header:"../../ops/data/data.h", importcpp:"BatchDatasetV2/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iibatchDatasetV2(scope: Scope,
                     ...
                     output_types: ArraySlice[DType],
                     output_shapes: ArraySlice[TensorShape]): BatchDatasetV2 {.header:"../../ops/data/data.h", importcpp:"BatchDatasetV2(*#, #, #, #, #, #)", constructor.}
...
type BatchFunction*[oT:oall] {.header:"../../ops/data/data.h", importcpp:"BatchFunction/*'0*/".} = object
...
proc iibatchFunction[oT: oall](scope: Scope,
                    ...
                    explicitT: type(oT)): BatchFunction[oT] {.header:"../../ops/data/data.h", importcpp:"BatchFunction(*#, #, #, #, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #, #, #, #, #, #)", constructor.}
...
type CacheDataset* {.header:"../../ops/data/data.h", importcpp:"CacheDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iicacheDataset(scope: Scope,
                   ...
                   filename: ostring,
                   output_types: ArraySlice[DType],
                   output_shapes: ArraySlice[TensorShape]): CacheDataset {.header:"../../ops/data/data.h", importcpp:"CacheDataset(*#, #, #, #, #)", constructor.}
...
type ConcatenateDataset* {.header:"../../ops/data/data.h", importcpp:"ConcatenateDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiconcatenateDataset(scope: Scope,
                         ...
                         output_types: ArraySlice[DType],
                         output_shapes: ArraySlice[TensorShape]): ConcatenateDataset {.header:"../../ops/data/data.h", importcpp:"ConcatenateDataset(*#, #, #, #, #)", constructor.}
...
type DatasetToGraph* {.header:"../../ops/data/data.h", importcpp:"DatasetToGraph/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iidatasetToGraph(scope: Scope,
                     input_dataset: ovariant): DatasetToGraph {.header:"../../ops/data/data.h", importcpp:"DatasetToGraph(*#, #)", constructor.}
...
type DatasetToSingleElement*[oT:oall] {.header:"../../ops/data/data.h", importcpp:"DatasetToSingleElement/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iidatasetToSingleElement[oT: oall](scope: Scope,
                             ...
                             explicitT: type(oT)): DatasetToSingleElement[oT] {.header:"../../ops/data/data.h", importcpp:"DatasetToSingleElement(*#, #, #, #)", constructor.}
...
type ExperimentalAssertNextDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalAssertNextDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalAssertNextDataset(scope: Scope,
                                    ...
                                    output_types: ArraySlice[DType],
                                    output_shapes: ArraySlice[TensorShape]): ExperimentalAssertNextDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalAssertNextDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalBytesProducedStatsDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalBytesProducedStatsDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalBytesProducedStatsDataset(scope: Scope,
                                            ...
                                            tag: ostring,
                                            output_types: ArraySlice[DType],
                                            output_shapes: ArraySlice[TensorShape]): ExperimentalBytesProducedStatsDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalBytesProducedStatsDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalCSVDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalCSVDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalCSVDataset(scope: Scope,
                             ...
                             output_types: ArraySlice[DType],
                             output_shapes: ArraySlice[TensorShape]): ExperimentalCSVDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalCSVDataset(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalDatasetCardinality* {.header:"../../ops/data/data.h", importcpp:"ExperimentalDatasetCardinality/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iiexperimentalDatasetCardinality(scope: Scope,
                                     input_dataset: ovariant): ExperimentalDatasetCardinality {.header:"../../ops/data/data.h", importcpp:"ExperimentalDatasetCardinality(*#, #)", constructor.}
...
type ExperimentalDatasetToTFRecord*{.header:"../../ops/data/data.h", importcpp:"ExperimentalDatasetToTFRecord/*'0*/".} = object
...
proc iiexperimentalDatasetToTFRecord(scope: Scope,
                                    input_dataset: ovariant,
                                    filename: ostring,
                                    compression_type: ostring): ExperimentalDatasetToTFRecord {.header:"../../ops/data/data.h", importcpp:"ExperimentalDatasetToTFRecord(*#, #, #, #)", constructor.}
...
type ExperimentalDenseToSparseBatchDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalDenseToSparseBatchDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalDenseToSparseBatchDataset(scope: Scope,
                                            ...
                                            row_shape: oint64,
                                            output_types: ArraySlice[DType],
                                            output_shapes: ArraySlice[TensorShape]): ExperimentalDenseToSparseBatchDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalDenseToSparseBatchDataset(*#, #, #, #, #, #)", constructor.}
...
type ExperimentalDirectedInterleaveDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalDirectedInterleaveDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalDirectedInterleaveDataset(scope: Scope,
                                            ...
                                            output_types: ArraySlice[DType],
                                            output_shapes: ArraySlice[TensorShape]): ExperimentalDirectedInterleaveDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalDirectedInterleaveDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalGroupByReducerDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalGroupByReducerDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalGroupByReducerDataset(scope: Scope,
                                        ...
                                        output_types: ArraySlice[DType],
                                        output_shapes: ArraySlice[TensorShape]): ExperimentalGroupByReducerDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalGroupByReducerDataset(*#, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalGroupByWindowDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalGroupByWindowDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalGroupByWindowDataset(scope: Scope,
                                       ...
                                       output_types: ArraySlice[DType],
                                       output_shapes: ArraySlice[TensorShape]): ExperimentalGroupByWindowDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalGroupByWindowDataset(*#, #, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalIdentityIndexedDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalIdentityIndexedDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iiexperimentalIdentityIndexedDataset(scope: Scope,
                                         size: ouint64): ExperimentalIdentityIndexedDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalIdentityIndexedDataset(*#, #)", constructor.}
...
type ExperimentalIgnoreErrorsDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalIgnoreErrorsDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalIgnoreErrorsDataset(scope: Scope,
                                      input_dataset: ovariant,
                                      output_types: ArraySlice[DType],
                                      output_shapes: ArraySlice[TensorShape]): ExperimentalIgnoreErrorsDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalIgnoreErrorsDataset(*#, #, #, #)", constructor.}
...
type ExperimentalIndexedDatasetGet*[oT:oall] {.header:"../../ops/data/data.h", importcpp:"ExperimentalIndexedDatasetGet/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiexperimentalIndexedDatasetGet[oT: oall](scope: Scope,
                                    ...
                                    output_types: ArraySlice[DType],
                                    output_shapes: ArraySlice[TensorShape],
                                    explicitT: type(oT)): ExperimentalIndexedDatasetGet[oT] {.header:"../../ops/data/data.h", importcpp:"ExperimentalIndexedDatasetGet(*#, #, #, #, #)", constructor.}
...
type ExperimentalIndexedDatasetMaterialize*{.header:"../../ops/data/data.h", importcpp:"ExperimentalIndexedDatasetMaterialize/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiexperimentalIndexedDatasetMaterialize(scope: Scope,
                                            dataset: ovariant,
                                            materialized: oresource): ExperimentalIndexedDatasetMaterialize {.header:"../../ops/data/data.h", importcpp:"ExperimentalIndexedDatasetMaterialize(*#, #, #)", constructor.}
...
type ExperimentalLMDBDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalLMDBDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalLMDBDataset(scope: Scope,
                              filenames: ostring,
                              output_types: ArraySlice[DType],
                              output_shapes: ArraySlice[TensorShape]): ExperimentalLMDBDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalLMDBDataset(*#, #, #, #)", constructor.}
...
type ExperimentalLatencyStatsDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalLatencyStatsDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalLatencyStatsDataset(scope: Scope,
                                      ...
                                      tag: ostring,
                                      output_types: ArraySlice[DType],
                                      output_shapes: ArraySlice[TensorShape]): ExperimentalLatencyStatsDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalLatencyStatsDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalMapAndBatchDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalMapAndBatchDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalMapAndBatchDataset(scope: Scope,
                                     ...
                                     output_types: ArraySlice[DType],
                                     output_shapes: ArraySlice[TensorShape],
                                     preserve_cardinality: bool): ExperimentalMapAndBatchDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalMapAndBatchDataset(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalMapDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalMapDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalMapDataset(scope: Scope,
                             ...
                             preserve_cardinality: bool): ExperimentalMapDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalMapDataset(*#, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalMatchingFilesDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalMatchingFilesDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iiexperimentalMatchingFilesDataset(scope: Scope,
                                       patterns: ostring): ExperimentalMatchingFilesDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalMatchingFilesDataset(*#, #)", constructor.}
...
type ExperimentalMaterializedIndexDatasetHandle* {.header:"../../ops/data/data.h", importcpp:"ExperimentalMaterializedIndexDatasetHandle/*'0*/".} = object
...
proc iiexperimentalMaterializedIndexDatasetHandle(scope: Scope,
                                                 ...
                                                 shared_name: cstring,
                                                 output_types: ArraySlice[DType],
                                                 output_shapes: ArraySlice[TensorShape]): ExperimentalMaterializedIndexDatasetHandle {.header:"../../ops/data/data.h", importcpp:"ExperimentalMaterializedIndexDatasetHandle(*#, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type ExperimentalMaxIntraOpParallelismDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalMaxIntraOpParallelismDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalMaxIntraOpParallelismDataset(scope: Scope,
                                               ...
                                               output_types: ArraySlice[DType],
                                               output_shapes: ArraySlice[TensorShape]): ExperimentalMaxIntraOpParallelismDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalMaxIntraOpParallelismDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalNonSerializableDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalNonSerializableDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalNonSerializableDataset(scope: Scope,
                                         input_dataset: ovariant,
                                         output_types: ArraySlice[DType],
                                         output_shapes: ArraySlice[TensorShape]): ExperimentalNonSerializableDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalNonSerializableDataset(*#, #, #, #)", constructor.}
...
type ExperimentalNumaMapAndBatchDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalNumaMapAndBatchDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalNumaMapAndBatchDataset(scope: Scope,
                                         ...
                                         output_types: ArraySlice[DType],
                                         output_shapes: ArraySlice[TensorShape],
                                         preserve_cardinality: bool): ExperimentalNumaMapAndBatchDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalNumaMapAndBatchDataset(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalParallelInterleaveDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalParallelInterleaveDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalParallelInterleaveDataset(scope: Scope,
                                            ...
                                            Targuments: ArraySlice[DType],
                                            output_types: ArraySlice[DType],
                                            output_shapes: ArraySlice[TensorShape]): ExperimentalParallelInterleaveDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalParallelInterleaveDataset(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalPrivateThreadPoolDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalPrivateThreadPoolDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalPrivateThreadPoolDataset(scope: Scope,
                                           ...
                                           num_threads: oint64,
                                           output_types: ArraySlice[DType],
                                           output_shapes: ArraySlice[TensorShape]): ExperimentalPrivateThreadPoolDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalPrivateThreadPoolDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalRandomDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalRandomDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalRandomDataset(scope: Scope,
                                ...
                                seed2: oint64,
                                output_types: ArraySlice[DType],
                                output_shapes: ArraySlice[TensorShape]): ExperimentalRandomDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalRandomDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalScanDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalScanDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalScanDataset(scope: Scope,
                              ...
                              output_types: ArraySlice[DType],
                              output_shapes: ArraySlice[TensorShape],
                              preserve_cardinality: bool): ExperimentalScanDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalScanDataset(*#, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ExperimentalSetStatsAggregatorDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalSetStatsAggregatorDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalSetStatsAggregatorDataset(scope: Scope,
                                            ...
                                            output_types: ArraySlice[DType],
                                            output_shapes: ArraySlice[TensorShape]): ExperimentalSetStatsAggregatorDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalSetStatsAggregatorDataset(*#, #, #, #, #, #, #)", constructor.}
...
type ExperimentalSleepDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalSleepDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalSleepDataset(scope: Scope,
                               ...
                               output_types: ArraySlice[DType],
                               output_shapes: ArraySlice[TensorShape]): ExperimentalSleepDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalSleepDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalSlidingWindowDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalSlidingWindowDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalSlidingWindowDataset(scope: Scope,
                                       ...
                                       output_types: ArraySlice[DType],
                                       output_shapes: ArraySlice[TensorShape]): ExperimentalSlidingWindowDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalSlidingWindowDataset(*#, #, #, #, #, #, #)", constructor.}
...
type ExperimentalSqlDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalSqlDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalSqlDataset(scope: Scope,
                             ...
                             query: ostring,
                             output_types: ArraySlice[DType],
                             output_shapes: ArraySlice[TensorShape]): ExperimentalSqlDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalSqlDataset(*#, #, #, #, #, #)", constructor.}
...
type ExperimentalThreadPoolDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalThreadPoolDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalThreadPoolDataset(scope: Scope,
                                    ...
                                    output_types: ArraySlice[DType],
                                    output_shapes: ArraySlice[TensorShape]): ExperimentalThreadPoolDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalThreadPoolDataset(*#, #, #, #, #)", constructor.}
...
type ExperimentalUnbatchDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalUnbatchDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalUnbatchDataset(scope: Scope,
                                 input_dataset: ovariant,
                                 output_types: ArraySlice[DType],
                                 output_shapes: ArraySlice[TensorShape]): ExperimentalUnbatchDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalUnbatchDataset(*#, #, #, #)", constructor.}
...
type ExperimentalUniqueDataset* {.header:"../../ops/data/data.h", importcpp:"ExperimentalUniqueDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiexperimentalUniqueDataset(scope: Scope,
                                input_dataset: ovariant,
                                output_types: ArraySlice[DType],
                                output_shapes: ArraySlice[TensorShape]): ExperimentalUniqueDataset {.header:"../../ops/data/data.h", importcpp:"ExperimentalUniqueDataset(*#, #, #, #)", constructor.}
...
type FilterByLastComponentDataset* {.header:"../../ops/data/data.h", importcpp:"FilterByLastComponentDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iifilterByLastComponentDataset(scope: Scope,
                                   input_dataset: ovariant,
                                   output_types: ArraySlice[DType],
                                   output_shapes: ArraySlice[TensorShape]): FilterByLastComponentDataset {.header:"../../ops/data/data.h", importcpp:"FilterByLastComponentDataset(*#, #, #, #)", constructor.}
...
type FilterDataset* {.header:"../../ops/data/data.h", importcpp:"FilterDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iifilterDataset(scope: Scope,
                    ...
                    Targuments: ArraySlice[DType],
                    output_types: ArraySlice[DType],
                    output_shapes: ArraySlice[TensorShape]): FilterDataset {.header:"../../ops/data/data.h", importcpp:"FilterDataset(*#, #, #, #, #, #, #)", constructor.}
...
type FixedLengthRecordDataset* {.header:"../../ops/data/data.h", importcpp:"FixedLengthRecordDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iifixedLengthRecordDataset(scope: Scope,
                               ...
                               record_bytes: oint64,
                               footer_bytes: oint64,
                               buffer_size: oint64): FixedLengthRecordDataset {.header:"../../ops/data/data.h", importcpp:"FixedLengthRecordDataset(*#, #, #, #, #, #)", constructor.}
...
type FixedLengthRecordDatasetV2* {.header:"../../ops/data/data.h", importcpp:"FixedLengthRecordDatasetV2/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iifixedLengthRecordDatasetV2(scope: Scope,
                                 ...
                                 footer_bytes: oint64,
                                 buffer_size: oint64,
                                 compression_type: ostring): FixedLengthRecordDatasetV2 {.header:"../../ops/data/data.h", importcpp:"FixedLengthRecordDatasetV2(*#, #, #, #, #, #, #)", constructor.}
...
type FlatMapDataset* {.header:"../../ops/data/data.h", importcpp:"FlatMapDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiflatMapDataset(scope: Scope,
                     ...
                     Targuments: ArraySlice[DType],
                     output_types: ArraySlice[DType],
                     output_shapes: ArraySlice[TensorShape]): FlatMapDataset {.header:"../../ops/data/data.h", importcpp:"FlatMapDataset(*#, #, #, #, #, #, #)", constructor.}
...
type GeneratorDataset* {.header:"../../ops/data/data.h", importcpp:"GeneratorDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iigeneratorDataset(scope: Scope,
                       ...
                       output_types: ArraySlice[DType],
                       output_shapes: ArraySlice[TensorShape]): GeneratorDataset {.header:"../../ops/data/data.h", importcpp:"GeneratorDataset(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type InterleaveDataset* {.header:"../../ops/data/data.h", importcpp:"InterleaveDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiinterleaveDataset(scope: Scope,
                        ...
                        Targuments: ArraySlice[DType],
                        output_types: ArraySlice[DType],
                        output_shapes: ArraySlice[TensorShape]): InterleaveDataset {.header:"../../ops/data/data.h", importcpp:"InterleaveDataset(*#, #, #, #, #, #, #, #, #)", constructor.}
...
type MapDataset* {.header:"../../ops/data/data.h", importcpp:"MapDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iimapDataset(scope: Scope,
                 ...
                 output_shapes: ArraySlice[TensorShape],
                 use_inter_op_parallelism: bool,
                 preserve_cardinality: bool): MapDataset {.header:"../../ops/data/data.h", importcpp:"MapDataset(*#, #, #, #, #, #, #, #, #)", constructor.}
...
type MapDefun*[oT:oall] {.header:"../../ops/data/data.h", importcpp:"MapDefun/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iimapDefun[oT: oall](scope: Scope,
               ...
               output_shapes: ArraySlice[TensorShape],
               f: NameAttrList,
               explicitT: type(oT)): MapDefun[oT] {.header:"../../ops/data/data.h", importcpp:"MapDefun(*#, #, #, #, #, #, #, #)", constructor.}
...
type ModelDataset* {.header:"../../ops/data/data.h", importcpp:"ModelDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iimodelDataset(scope: Scope,
                   input_dataset: ovariant,
                   output_types: ArraySlice[DType],
                   output_shapes: ArraySlice[TensorShape]): ModelDataset {.header:"../../ops/data/data.h", importcpp:"ModelDataset(*#, #, #, #)", constructor.}
...
type OptimizeDataset* {.header:"../../ops/data/data.h", importcpp:"OptimizeDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iioptimizeDataset(scope: Scope,
                      ...
                      output_types: ArraySlice[DType],
                      output_shapes: ArraySlice[TensorShape]): OptimizeDataset {.header:"../../ops/data/data.h", importcpp:"OptimizeDataset(*#, #, #, #, #)", constructor.}
...
type PaddedBatchDatasetV2* {.header:"../../ops/data/data.h", importcpp:"PaddedBatchDatasetV2/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iipaddedBatchDatasetV2(scope: Scope,
                           ...
                           output_shapes: ArraySlice[TensorShape]): PaddedBatchDatasetV2 {.header:"../../ops/data/data.h", importcpp:"PaddedBatchDatasetV2(*#, #, #, #, #, #, #, #)", constructor.}
...
type ParallelInterleaveDatasetV2* {.header:"../../ops/data/data.h", importcpp:"ParallelInterleaveDatasetV2/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiparallelInterleaveDatasetV2(scope: Scope,
                                  ...
                                  output_types: ArraySlice[DType],
                                  output_shapes: ArraySlice[TensorShape],
                                  sloppy: bool): ParallelInterleaveDatasetV2 {.header:"../../ops/data/data.h", importcpp:"ParallelInterleaveDatasetV2(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ParallelMapDataset* {.header:"../../ops/data/data.h", importcpp:"ParallelMapDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiparallelMapDataset(scope: Scope,
                         ...
                         use_inter_op_parallelism: bool,
                         sloppy: bool,
                         preserve_cardinality: bool): ParallelMapDataset {.header:"../../ops/data/data.h", importcpp:"ParallelMapDataset(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type PrefetchDataset* {.header:"../../ops/data/data.h", importcpp:"PrefetchDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiprefetchDataset(scope: Scope,
                      ...
                      buffer_size: oint64,
                      output_types: ArraySlice[DType],
                      output_shapes: ArraySlice[TensorShape]): PrefetchDataset {.header:"../../ops/data/data.h", importcpp:"PrefetchDataset(*#, #, #, #, #)", constructor.}
...
type RangeDataset* {.header:"../../ops/data/data.h", importcpp:"RangeDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iirangeDataset(scope: Scope,
                   ...
                   step: oint64,
                   output_types: ArraySlice[DType],
                   output_shapes: ArraySlice[TensorShape]): RangeDataset {.header:"../../ops/data/data.h", importcpp:"RangeDataset(*#, #, #, #, #, #)", constructor.}
...
type ReduceDataset*[oT:oall] {.header:"../../ops/data/data.h", importcpp:"ReduceDataset/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iireduceDataset[oT: oall](scope: Scope,
                    ...
                    output_shapes: ArraySlice[TensorShape],
                    use_inter_op_parallelism: bool,
                    explicitT: type(oT)): ReduceDataset[oT] {.header:"../../ops/data/data.h", importcpp:"ReduceDataset(*#, #, #, #, #, #, #, #, #, #)", constructor.}
...
type RepeatDataset* {.header:"../../ops/data/data.h", importcpp:"RepeatDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iirepeatDataset(scope: Scope,
                    ...
                    count: oint64,
                    output_types: ArraySlice[DType],
                    output_shapes: ArraySlice[TensorShape]): RepeatDataset {.header:"../../ops/data/data.h", importcpp:"RepeatDataset(*#, #, #, #, #)", constructor.}
...
type ShuffleAndRepeatDataset* {.header:"../../ops/data/data.h", importcpp:"ShuffleAndRepeatDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iishuffleAndRepeatDataset(scope: Scope,
                              ...
                              count: oint64,
                              output_types: ArraySlice[DType],
                              output_shapes: ArraySlice[TensorShape]): ShuffleAndRepeatDataset {.header:"../../ops/data/data.h", importcpp:"ShuffleAndRepeatDataset(*#, #, #, #, #, #, #, #)", constructor.}
...
type ShuffleDataset* {.header:"../../ops/data/data.h", importcpp:"ShuffleDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iishuffleDataset(scope: Scope,
                     ...
                     output_types: ArraySlice[DType],
                     output_shapes: ArraySlice[TensorShape],
                     reshuffle_each_iteration: bool): ShuffleDataset {.header:"../../ops/data/data.h", importcpp:"ShuffleDataset(*#, #, #, #, #, #, #, #)", constructor.}
...
type SkipDataset* {.header:"../../ops/data/data.h", importcpp:"SkipDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiskipDataset(scope: Scope,
                  ...
                  count: oint64,
                  output_types: ArraySlice[DType],
                  output_shapes: ArraySlice[TensorShape]): SkipDataset {.header:"../../ops/data/data.h", importcpp:"SkipDataset(*#, #, #, #, #)", constructor.}
...
type SparseTensorSliceDataset* {.header:"../../ops/data/data.h", importcpp:"SparseTensorSliceDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iisparseTensorSliceDataset(scope: Scope,
                               ...
                               dense_shape: oint64): SparseTensorSliceDataset {.header:"../../ops/data/data.h", importcpp:"SparseTensorSliceDataset(*#, #, #, #)", constructor.}
...
type TFRecordDataset* {.header:"../../ops/data/data.h", importcpp:"TFRecordDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitFRecordDataset(scope: Scope,
                      filenames: ostring,
                      compression_type: ostring,
                      buffer_size: oint64): TFRecordDataset {.header:"../../ops/data/data.h", importcpp:"TFRecordDataset(*#, #, #, #)", constructor.}
...
type TakeDataset* {.header:"../../ops/data/data.h", importcpp:"TakeDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitakeDataset(scope: Scope,
                  ...
                  count: oint64,
                  output_types: ArraySlice[DType],
                  output_shapes: ArraySlice[TensorShape]): TakeDataset {.header:"../../ops/data/data.h", importcpp:"TakeDataset(*#, #, #, #, #)", constructor.}
...
type TensorDataset* {.header:"../../ops/data/data.h", importcpp:"TensorDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorDataset(scope: Scope,
                    ...
                    Toutput_types: ArraySlice[DType],
                    output_shapes: ArraySlice[TensorShape]): TensorDataset {.header:"../../ops/data/data.h", importcpp:"TensorDataset(*#, #, #, #)", constructor.}
...
type TensorSliceDataset* {.header:"../../ops/data/data.h", importcpp:"TensorSliceDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorSliceDataset(scope: Scope,
                         components: olist[oall],
                         Toutput_types: ArraySlice[DType],
                         output_shapes: ArraySlice[TensorShape]): TensorSliceDataset {.header:"../../ops/data/data.h", importcpp:"TensorSliceDataset(*#, #, #, #)", constructor.}
...
type TextLineDataset* {.header:"../../ops/data/data.h", importcpp:"TextLineDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitextLineDataset(scope: Scope,
                      filenames: ostring,
                      compression_type: ostring,
                      buffer_size: oint64): TextLineDataset {.header:"../../ops/data/data.h", importcpp:"TextLineDataset(*#, #, #, #)", constructor.}
...
type UnwrapDatasetVariant* {.header:"../../ops/data/data.h", importcpp:"UnwrapDatasetVariant/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iiunwrapDatasetVariant(scope: Scope,
                           input_handle: ovariant): UnwrapDatasetVariant {.header:"../../ops/data/data.h", importcpp:"UnwrapDatasetVariant(*#, #)", constructor.}
...
type WindowDataset* {.header:"../../ops/data/data.h", importcpp:"WindowDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iiwindowDataset(scope: Scope,
                    ...
                    drop_remainder: obool,
                    output_types: ArraySlice[DType],
                    output_shapes: ArraySlice[TensorShape]): WindowDataset {.header:"../../ops/data/data.h", importcpp:"WindowDataset(*#, #, #, #, #, #, #, #)", constructor.}
...
type WrapDatasetVariant* {.header:"../../ops/data/data.h", importcpp:"WrapDatasetVariant/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iiwrapDatasetVariant(scope: Scope,
                         input_handle: ovariant): WrapDatasetVariant {.header:"../../ops/data/data.h", importcpp:"WrapDatasetVariant(*#, #)", constructor.}
...
type ZipDataset* {.header:"../../ops/data/data.h", importcpp:"ZipDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iizipDataset(scope: Scope,
                 ...
                 output_types: ArraySlice[DType],
                 output_shapes: ArraySlice[TensorShape]): ZipDataset {.header:"../../ops/data/data.h", importcpp:"ZipDataset(*#, #, #, #)", constructor.}
