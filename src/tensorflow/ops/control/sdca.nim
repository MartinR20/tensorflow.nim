...
proc iisdcaOptimizer(scope: Scope,
                    sparse_example_indices: olist[oint64],
                    sparse_feature_indices: olist[oint64],
                    sparse_feature_values: olist[ofloat],
                    dense_features: olist[ofloat],
                    example_weights: ofloat,
                    example_labels: ofloat,
                    sparse_indices: olist[oint64],
                    sparse_weights: olist[ofloat],
                    dense_weights: olist[ofloat],
