...
{.compile:"../../ops/datastructure/datastructure.cc".}

type AddManySparseToTensorsMapT* = oall

type AddManySparseToTensorsMap* {.header:"../../ops/datastructure/datastructure.h", importcpp:"AddManySparseToTensorsMap/*'0*/".} = object
...
proc iiaddManySparseToTensorsMap(scope: Scope,
                                ...
                                sparse_shape: oint64,
                                container: cstring,
                                shared_name: cstring): AddManySparseToTensorsMap {.header:"../../ops/datastructure/datastructure.h", importcpp:"AddManySparseToTensorsMap(*#, #, #, #, tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type AddSparseToTensorsMap* {.header:"../../ops/datastructure/datastructure.h", importcpp:"AddSparseToTensorsMap/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiaddSparseToTensorsMap(scope: Scope,
                            ...
                            sparse_shape: oint64,
                            container: cstring,
                            shared_name: cstring): AddSparseToTensorsMap {.header:"../../ops/datastructure/datastructure.h", importcpp:"AddSparseToTensorsMap(*#, #, #, #, tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type CropAndResizeGradBoxes* {.header:"../../ops/datastructure/datastructure.h", importcpp:"CropAndResizeGradBoxes/*'0*/".} = object
...
proc iicropAndResizeGradBoxes(scope: Scope,
                             ...
                             boxes: ofloat,
                             box_ind: oint32,
                             nmethod: cstring): CropAndResizeGradBoxes {.header:"../../ops/datastructure/datastructure.h", importcpp:"CropAndResizeGradBoxes(*#, #, #, #, #, tensorflow::string(#))", constructor.}
...
type DataFormatVecPermute*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"DataFormatVecPermute/*'0*/".} = object
...
proc iidataFormatVecPermute[oT: oall](scope: Scope,
                           ...
                           T: DType,
                           src_format: cstring,
                           dst_format: cstring): DataFormatVecPermute[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"DataFormatVecPermute(*#, #, #, tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type HashTable* {.header:"../../ops/datastructure/datastructure.h", importcpp:"HashTable/*'0*/".} = object
...
proc iihashTable(scope: Scope,
                ...
                key_dtype: DType,
                value_dtype: DType): HashTable {.header:"../../ops/datastructure/datastructure.h", importcpp:"HashTable(*#, tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type HashTableV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"HashTableV2/*'0*/".} = object
...
proc iihashTableV2(scope: Scope,
                  ...
                  use_node_name_sharing: bool,
                  key_dtype: DType,
                  value_dtype: DType): HashTableV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"HashTableV2(*#, tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type InitializeTable*{.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTable/*'0*/".} = object
...
proc iiinitializeTable(scope: Scope,
                      ...
                      values: InitializeTableTval): InitializeTable {.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTable(*#, #, #, #)", constructor.}
...
type InitializeTableFromTextFile*{.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTableFromTextFile/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiinitializeTableFromTextFile(scope: Scope,
                                  ...
                                  value_index: int64,
                                  vocab_size: int64,
                                  delimiter: cstring): InitializeTableFromTextFile {.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTableFromTextFile(*#, #, #, #, #, #, tensorflow::string(#))", constructor.}
...
type InitializeTableFromTextFileV2*{.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTableFromTextFileV2/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiinitializeTableFromTextFileV2(scope: Scope,
                                    ...
                                    value_index: int64,
                                    vocab_size: int64,
                                    delimiter: cstring): InitializeTableFromTextFileV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTableFromTextFileV2(*#, #, #, #, #, #, tensorflow::string(#))", constructor.}
...
type InitializeTableV2*{.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTableV2/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiinitializeTableV2(scope: Scope,
                        ...
                        values: InitializeTableV2Tval): InitializeTableV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"InitializeTableV2(*#, #, #, #)", constructor.}
...
type MapClear*{.header:"../../ops/datastructure/datastructure.h", importcpp:"MapClear/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iimapClear(scope: Scope,
               ...
               shared_name: cstring,
               capacity: int64,
               memory_limit: int64): MapClear {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapClear(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MapIncompleteSize* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapIncompleteSize/*'0*/".} = object
...
proc iimapIncompleteSize(scope: Scope,
                        ...
                        shared_name: cstring,
                        capacity: int64,
                        memory_limit: int64): MapIncompleteSize {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapIncompleteSize(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MapPeek*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapPeek/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iimapPeek[oT: oall](scope: Scope,
              ...
              capacity: int64,
              memory_limit: int64,
              explicitT: type(oT)): MapPeek[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapPeek(*#, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MapSize* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iimapSize(scope: Scope,
              ...
              shared_name: cstring,
              capacity: int64,
              memory_limit: int64): MapSize {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapSize(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MapStage*{.header:"../../ops/datastructure/datastructure.h", importcpp:"MapStage/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iimapStage(scope: Scope,
               ...
               shared_name: cstring,
               capacity: int64,
               memory_limit: int64): MapStage {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapStage(*#, #, #, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MapUnstage*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapUnstage/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iimapUnstage[oT: oall](scope: Scope,
                 ...
                 capacity: int64,
                 memory_limit: int64,
                 explicitT: type(oT)): MapUnstage[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapUnstage(*#, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MapUnstageNoKey* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapUnstageNoKey/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iimapUnstageNoKey(scope: Scope,
                      ...
                      shared_name: cstring,
                      capacity: int64,
                      memory_limit: int64): MapUnstageNoKey {.header:"../../ops/datastructure/datastructure.h", importcpp:"MapUnstageNoKey(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type MutableDenseHashTable* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableDenseHashTable/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iimutableDenseHashTable(scope: Scope,
                            ...
                            initial_num_buckets: int64): MutableDenseHashTable {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableDenseHashTable(*#, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type MutableDenseHashTableV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableDenseHashTableV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iimutableDenseHashTableV2(scope: Scope,
                              ...
                              value_dtype: DType,
                              value_shape: TensorShape,
                              initial_num_buckets: int64): MutableDenseHashTableV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableDenseHashTableV2(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type MutableHashTable* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableHashTable/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iimutableHashTable(scope: Scope,
                       ...
                       use_node_name_sharing: bool,
                       key_dtype: DType,
                       value_dtype: DType): MutableHashTable {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableHashTable(*#, tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type MutableHashTableOfTensors* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableHashTableOfTensors/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iimutableHashTableOfTensors(scope: Scope,
                                ...
                                key_dtype: DType,
                                value_dtype: DType,
                                value_shape: TensorShape): MutableHashTableOfTensors {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableHashTableOfTensors(*#, tensorflow::string(#), tensorflow::string(#), #, #, #, #)", constructor.}
...
type MutableHashTableOfTensorsV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableHashTableOfTensorsV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iimutableHashTableOfTensorsV2(scope: Scope,
                                  ...
                                  key_dtype: DType,
                                  value_dtype: DType,
                                  value_shape: TensorShape): MutableHashTableOfTensorsV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"MutableHashTableOfTensorsV2(*#, tensorflow::string(#), tensorflow::string(#), #, #, #, #)", constructor.}
...
type OrderedMapClear*{.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapClear/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiorderedMapClear(scope: Scope,
                      ...
                      shared_name: cstring,
                      capacity: int64,
                      memory_limit: int64): OrderedMapClear {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapClear(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type OrderedMapIncompleteSize* {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapIncompleteSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iiorderedMapIncompleteSize(scope: Scope,
                               ...
                               shared_name: cstring,
                               capacity: int64,
                               memory_limit: int64): OrderedMapIncompleteSize {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapIncompleteSize(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type OrderedMapPeek*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapPeek/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiorderedMapPeek[oT: oall](scope: Scope,
                     ...
                     capacity: int64,
                     memory_limit: int64,
                     explicitT: type(oT)): OrderedMapPeek[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapPeek(*#, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type OrderedMapSize* {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iiorderedMapSize(scope: Scope,
                     ...
                     shared_name: cstring,
                     capacity: int64,
                     memory_limit: int64): OrderedMapSize {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapSize(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type OrderedMapStage*{.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapStage/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiorderedMapStage(scope: Scope,
                      ...
                      shared_name: cstring,
                      capacity: int64,
                      memory_limit: int64): OrderedMapStage {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapStage(*#, #, #, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type OrderedMapUnstage*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapUnstage/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiorderedMapUnstage[oT: oall](scope: Scope,
                        ...
                        capacity: int64,
                        memory_limit: int64,
                        explicitT: type(oT)): OrderedMapUnstage[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapUnstage(*#, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type OrderedMapUnstageNoKey* {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapUnstageNoKey/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiorderedMapUnstageNoKey(scope: Scope,
                             ...
                             shared_name: cstring,
                             capacity: int64,
                             memory_limit: int64): OrderedMapUnstageNoKey {.header:"../../ops/datastructure/datastructure.h", importcpp:"OrderedMapUnstageNoKey(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type ParallelDynamicStitch*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"ParallelDynamicStitch/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiparallelDynamicStitch[oT: oall](scope: Scope,
                            ...
                            data: olist[oT],
                            T: DType): ParallelDynamicStitch[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"ParallelDynamicStitch(*#, #, #, #)", constructor.}
...
type StackClose*{.header:"../../ops/datastructure/datastructure.h", importcpp:"StackClose/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iistackClose(scope: Scope,
                 handle: ostring): StackClose {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackClose(*#, #)", constructor.}
...
type StackCloseV2*{.header:"../../ops/datastructure/datastructure.h", importcpp:"StackCloseV2/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iistackCloseV2(scope: Scope,
                   handle: oresource): StackCloseV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackCloseV2(*#, #)", constructor.}
...
type StackPop*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackPop/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistackPop[oT: oall](scope: Scope,
               handle: ostring,
               elem_type: DType,
               explicitT: type(oT)): StackPop[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackPop(*#, #, #)", constructor.}
...
type StackPopV2*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackPopV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistackPopV2[oT: oall](scope: Scope,
                 handle: oresource,
                 elem_type: DType,
                 explicitT: type(oT)): StackPopV2[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackPopV2(*#, #, #)", constructor.}
...
type StackPushV2*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackPushV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistackPushV2[oT: oall](scope: Scope,
                  ...
                  elem: oT,
                  T: DType,
                  swap_memory: bool): StackPushV2[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"StackPushV2(*#, #, #, #, #)", constructor.}
...
type TakeManySparseFromTensorsMap* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TakeManySparseFromTensorsMap/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iitakeManySparseFromTensorsMap(scope: Scope,
                                   ...
                                   container: cstring,
                                   shared_name: cstring,
                                   dtype: DType): TakeManySparseFromTensorsMap {.header:"../../ops/datastructure/datastructure.h", importcpp:"TakeManySparseFromTensorsMap(*#, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type TensorArray* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArray/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iitensorArray(scope: Scope,
                  ...
                  element_shape: TensorShape): TensorArray {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArray(*#, #, tensorflow::string(#), #, #, #, #)", constructor.}
...
type TensorArrayClose*{.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayClose/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iitensorArrayClose(scope: Scope,
                       handle: ostring): TensorArrayClose {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayClose(*#, #)", constructor.}
...
type TensorArrayCloseV2*{.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayCloseV2/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iitensorArrayCloseV2(scope: Scope,
                         handle: ostring): TensorArrayCloseV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayCloseV2(*#, #)", constructor.}
...
type TensorArrayCloseV3*{.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayCloseV3/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iitensorArrayCloseV3(scope: Scope,
                         handle: oresource): TensorArrayCloseV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayCloseV3(*#, #)", constructor.}
...
type TensorArrayConcat*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayConcat/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayConcat[oT: oall](scope: Scope,
                        ...
                        explicitT: type(oT)): TensorArrayConcat[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayConcat(*#, #, #, #, #)", constructor.}
...
type TensorArrayConcatV2*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayConcatV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayConcatV2[oT: oall](scope: Scope,
                          ...
                          dtype: DType,
                          element_shape_except0: TensorShape,
                          explicitT: type(oT)): TensorArrayConcatV2[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayConcatV2(*#, #, #, #, #)", constructor.}
...
type TensorArrayConcatV3*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayConcatV3/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayConcatV3[oT: oall](scope: Scope,
                          ...
                          dtype: DType,
                          element_shape_except0: TensorShape,
                          explicitT: type(oT)): TensorArrayConcatV3[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayConcatV3(*#, #, #, #, #)", constructor.}
...
type TensorArrayGather*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGather/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayGather[oT: oall](scope: Scope,
                        ...
                        explicitT: type(oT)): TensorArrayGather[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGather(*#, #, #, #, #, #)", constructor.}
...
type TensorArrayGatherV2*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGatherV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayGatherV2[oT: oall](scope: Scope,
                          ...
                          dtype: DType,
                          element_shape: TensorShape,
                          explicitT: type(oT)): TensorArrayGatherV2[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGatherV2(*#, #, #, #, #, #)", constructor.}
...
type TensorArrayGatherV3*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGatherV3/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayGatherV3[oT: oall](scope: Scope,
                          ...
                          dtype: DType,
                          element_shape: TensorShape,
                          explicitT: type(oT)): TensorArrayGatherV3[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGatherV3(*#, #, #, #, #, #)", constructor.}
...
type TensorArrayGrad* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGrad/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iitensorArrayGrad(scope: Scope,
                      handle: ostring,
                      flow_in: ofloat,
                      source: cstring): TensorArrayGrad {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGrad(*#, #, #, tensorflow::string(#))", constructor.}
...
type TensorArrayGradV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGradV2/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iitensorArrayGradV2(scope: Scope,
                        handle: ostring,
                        flow_in: ofloat,
                        source: cstring): TensorArrayGradV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGradV2(*#, #, #, tensorflow::string(#))", constructor.}
...
type TensorArrayGradV3* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGradV3/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iitensorArrayGradV3(scope: Scope,
                        handle: oresource,
                        flow_in: ofloat,
                        source: cstring): TensorArrayGradV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGradV3(*#, #, #, tensorflow::string(#))", constructor.}
...
type TensorArrayGradWithShape* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGradWithShape/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iitensorArrayGradWithShape(scope: Scope,
                               ...
                               source: cstring): TensorArrayGradWithShape {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayGradWithShape(*#, #, #, #, tensorflow::string(#))", constructor.}
...
type TensorArrayPack*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayPack/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayPack[oT: oall](scope: Scope,
                      ...
                      dtype: DType,
                      element_shape: TensorShape,
                      explicitT: type(oT)): TensorArrayPack[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayPack(*#, #, #, #, #)", constructor.}
...
type TensorArrayRead*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayRead/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayRead[oT: oall](scope: Scope,
                      ...
                      flow_in: ofloat,
                      dtype: DType,
                      explicitT: type(oT)): TensorArrayRead[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayRead(*#, #, #, #, #)", constructor.}
...
type TensorArrayReadV2*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayReadV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayReadV2[oT: oall](scope: Scope,
                        ...
                        flow_in: ofloat,
                        dtype: DType,
                        explicitT: type(oT)): TensorArrayReadV2[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayReadV2(*#, #, #, #, #)", constructor.}
...
type TensorArrayReadV3*[oT:oall] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayReadV3/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorArrayReadV3[oT: oall](scope: Scope,
                        ...
                        flow_in: ofloat,
                        dtype: DType,
                        explicitT: type(oT)): TensorArrayReadV3[oT] {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayReadV3(*#, #, #, #, #)", constructor.}
...
type TensorArrayScatter* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayScatter/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayScatter(scope: Scope,
                         ...
                         flow_in: ofloat): TensorArrayScatter {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayScatter(*#, #, #, #, #)", constructor.}
...
type TensorArrayScatterV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayScatterV2/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayScatterV2(scope: Scope,
                           ...
                           flow_in: ofloat): TensorArrayScatterV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayScatterV2(*#, #, #, #, #)", constructor.}
...
type TensorArrayScatterV3* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayScatterV3/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayScatterV3(scope: Scope,
                           ...
                           flow_in: ofloat): TensorArrayScatterV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayScatterV3(*#, #, #, #, #)", constructor.}
...
type TensorArraySize* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iitensorArraySize(scope: Scope,
                      handle: ostring,
                      flow_in: ofloat): TensorArraySize {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySize(*#, #, #)", constructor.}
...
type TensorArraySizeV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySizeV2/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iitensorArraySizeV2(scope: Scope,
                        handle: ostring,
                        flow_in: ofloat): TensorArraySizeV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySizeV2(*#, #, #)", constructor.}
...
type TensorArraySizeV3* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySizeV3/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iitensorArraySizeV3(scope: Scope,
                        handle: oresource,
                        flow_in: ofloat): TensorArraySizeV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySizeV3(*#, #, #)", constructor.}
...
type TensorArraySplit* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySplit/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArraySplit(scope: Scope,
                       ...
                       lengths: oint64,
                       flow_in: ofloat): TensorArraySplit {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySplit(*#, #, #, #, #)", constructor.}
...
type TensorArraySplitV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySplitV2/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArraySplitV2(scope: Scope,
                         ...
                         lengths: oint64,
                         flow_in: ofloat): TensorArraySplitV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySplitV2(*#, #, #, #, #)", constructor.}
...
type TensorArraySplitV3* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySplitV3/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArraySplitV3(scope: Scope,
                         ...
                         lengths: oint64,
                         flow_in: ofloat): TensorArraySplitV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArraySplitV3(*#, #, #, #, #)", constructor.}
...
type TensorArrayUnpack* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayUnpack/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayUnpack(scope: Scope,
                        ...
                        flow_in: ofloat): TensorArrayUnpack {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayUnpack(*#, #, #, #)", constructor.}
...
type TensorArrayV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayV2/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iitensorArrayV2(scope: Scope,
                    ...
                    element_shape: TensorShape,
                    dynamic_size: bool,
                    clear_after_read: bool): TensorArrayV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayV2(*#, #, tensorflow::string(#), #, #, #, #)", constructor.}
...
type TensorArrayV3* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayV3/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iitensorArrayV3(scope: Scope,
                    ...
                    dynamic_size: bool,
                    clear_after_read: bool,
                    identical_element_shapes: bool): TensorArrayV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayV3(*#, #, tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type TensorArrayWrite* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayWrite/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayWrite(scope: Scope,
                       ...
                       flow_in: ofloat): TensorArrayWrite {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayWrite(*#, #, #, #, #)", constructor.}
...
type TensorArrayWriteV2* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayWriteV2/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayWriteV2(scope: Scope,
                         ...
                         flow_in: ofloat): TensorArrayWriteV2 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayWriteV2(*#, #, #, #, #)", constructor.}
...
type TensorArrayWriteV3* {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayWriteV3/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iitensorArrayWriteV3(scope: Scope,
                         ...
                         flow_in: ofloat): TensorArrayWriteV3 {.header:"../../ops/datastructure/datastructure.h", importcpp:"TensorArrayWriteV3(*#, #, #, #, #)", constructor.}
