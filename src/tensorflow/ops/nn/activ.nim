...
{.compile:"../../ops/nn/activ/activ.cc".}


type Elu*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Elu/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iielu[oT: oall](scope: Scope,
          features: oT,
          T: DType): Elu[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Elu(*#, #, #)", constructor.}
...
type EluGrad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"EluGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iieluGrad[oT: oall](scope: Scope,
              gradients: oT,
              outputs: oT,
              T: DType): EluGrad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"EluGrad(*#, #, #, #)", constructor.}
...
type LeakyRelu*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"LeakyRelu/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iileakyRelu[oT: oall](scope: Scope,
                features: oT,
                alpha: float32,
                T: DType): LeakyRelu[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"LeakyRelu(*#, #, #, #)", constructor.}
...
type LeakyReluGrad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"LeakyReluGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iileakyReluGrad[oT: oall](scope: Scope,
                    ...
                    features: oT,
                    alpha: float32,
                    T: DType): LeakyReluGrad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"LeakyReluGrad(*#, #, #, #, #)", constructor.}
...
type LogSoftmax*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"LogSoftmax/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iilogSoftmax[oT: oall](scope: Scope,
                 logits: oT,
                 T: DType): LogSoftmax[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"LogSoftmax(*#, #, #)", constructor.}
...
type QuantizedRelu*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"QuantizedRelu/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizedRelu[oT: oall](scope: Scope,
                    ...
                    max_features: ofloat,
                    out_type: DType,
                    explicitT: type(oT)): QuantizedRelu[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"QuantizedRelu(*#, #, #, #, #)", constructor.}
...
type QuantizedReluX*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"QuantizedReluX/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizedReluX[oT: oall](scope: Scope,
                     ...
                     max_features: ofloat,
                     out_type: DType,
                     explicitT: type(oT)): QuantizedReluX[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"QuantizedReluX(*#, #, #, #, #, #)", constructor.}
...
type Relu*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Relu/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iirelu[oT: oall](scope: Scope,
           features: oT,
           T: DType): Relu[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Relu(*#, #, #)", constructor.}
...
type Relu6*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Relu6/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iirelu6[oT: oall](scope: Scope,
            features: oT,
            T: DType): Relu6[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Relu6(*#, #, #)", constructor.}
...
type Relu6Grad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Relu6Grad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirelu6Grad[oT: oall](scope: Scope,
                gradients: oT,
                features: oT,
                T: DType): Relu6Grad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Relu6Grad(*#, #, #, #)", constructor.}
...
type ReluGrad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"ReluGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iireluGrad[oT: oall](scope: Scope,
               gradients: oT,
               features: oT,
               T: DType): ReluGrad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"ReluGrad(*#, #, #, #)", constructor.}
...
type Selu*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Selu/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iiselu[oT: oall](scope: Scope,
           features: oT,
           T: DType): Selu[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Selu(*#, #, #)", constructor.}
...
type Sigmoid*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Sigmoid/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iisigmoid[oT: oall](scope: Scope,
              x: oT,
              T: DType): Sigmoid[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Sigmoid(*#, #, #)", constructor.}
...
type SigmoidGrad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"SigmoidGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisigmoidGrad[oT: oall](scope: Scope,
                  y: oT,
                  dy: oT,
                  T: DType): SigmoidGrad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"SigmoidGrad(*#, #, #, #)", constructor.}
...
type Softmax*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Softmax/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iisoftmax[oT: oall](scope: Scope,
              logits: oT,
              T: DType): Softmax[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Softmax(*#, #, #)", constructor.}
...
type SoftmaxCrossEntropyWithLogits*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"SoftmaxCrossEntropyWithLogits/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisoftmaxCrossEntropyWithLogits[oT: oall](scope: Scope,
                                    features: oT,
                                    labels: oT,
                                    T: DType): SoftmaxCrossEntropyWithLogits[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"SoftmaxCrossEntropyWithLogits(*#, #, #, #)", constructor.}
...
type Softplus*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"Softplus/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iisoftplus[oT: oall](scope: Scope,
               features: oT,
               T: DType): Softplus[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"Softplus(*#, #, #)", constructor.}
...
type SoftplusGrad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"SoftplusGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisoftplusGrad[oT: oall](scope: Scope,
                   gradients: oT,
                   features: oT,
                   T: DType): SoftplusGrad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"SoftplusGrad(*#, #, #, #)", constructor.}
...
type SoftsignGrad*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"SoftsignGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisoftsignGrad[oT: oall](scope: Scope,
                   gradients: oT,
                   features: oT,
                   T: DType): SoftsignGrad[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"SoftsignGrad(*#, #, #, #)", constructor.}
...
type SparseSoftmax*[oT:oall] {.header:"../../ops/nn/activ/activ.h", importcpp:"SparseSoftmax/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseSoftmax[oT: oall](scope: Scope,
                    ...
                    sp_values: oT,
                    sp_shape: oint64,
                    T: DType): SparseSoftmax[oT] {.header:"../../ops/nn/activ/activ.h", importcpp:"SparseSoftmax(*#, #, #, #, #)", constructor.}
