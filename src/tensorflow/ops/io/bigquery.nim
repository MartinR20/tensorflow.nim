...
{.compile:"../../ops/io/bigquery/bigquery.cc".}


type BigQueryReader* {.header:"../../ops/io/bigquery/bigquery.h", importcpp:"BigQueryReader/*'0*/".} = object
...
proc iibigQueryReader(scope: Scope,
                     ...
                     timestamp_millis: int64): BigQueryReader {.header:"../../ops/io/bigquery/bigquery.h", importcpp:"BigQueryReader(*#, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, tensorflow::string(#), #)", constructor.}
...
type GenerateBigQueryReaderPartitions* {.header:"../../ops/io/bigquery/bigquery.h", importcpp:"GenerateBigQueryReaderPartitions/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iigenerateBigQueryReaderPartitions(scope: Scope,
                                       ...
                                       num_partitions: int64): GenerateBigQueryReaderPartitions {.header:"../../ops/io/bigquery/bigquery.h", importcpp:"GenerateBigQueryReaderPartitions(*#, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, tensorflow::string(#), #, #)", constructor.}
