...
{.compile:"../../ops/array/array.cc".}


type AccumulateNV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"AccumulateNV2/*'0*/".} = object
...
proc iiaccumulateNV2[oT: oall](scope: Scope,
                    inputs: olist[oT],
                    T: DType,
                    shape: TensorShape): AccumulateNV2[oT] {.header:"../../ops/array/array.h", importcpp:"AccumulateNV2(*#, #, #, #)", constructor.}
...
type AccumulatorNumAccumulated* {.header:"../../ops/array/array.h", importcpp:"AccumulatorNumAccumulated/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iiaccumulatorNumAccumulated(scope: Scope,
                                handle: ostring): AccumulatorNumAccumulated {.header:"../../ops/array/array.h", importcpp:"AccumulatorNumAccumulated(*#, #)", constructor.}
...
type AccumulatorSetGlobalStep*{.header:"../../ops/array/array.h", importcpp:"AccumulatorSetGlobalStep/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiaccumulatorSetGlobalStep(scope: Scope,
                               handle: ostring,
                               new_global_step: oint64): AccumulatorSetGlobalStep {.header:"../../ops/array/array.h", importcpp:"AccumulatorSetGlobalStep(*#, #, #)", constructor.}
...
type AccumulatorTakeGradient*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"AccumulatorTakeGradient/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiaccumulatorTakeGradient[oT: oall](scope: Scope,
                              ...
                              num_required: oint32,
                              dtype: DType,
                              explicitT: type(oT)): AccumulatorTakeGradient[oT] {.header:"../../ops/array/array.h", importcpp:"AccumulatorTakeGradient(*#, #, #, #)", constructor.}
...
type Any* {.header:"../../ops/array/array.h", importcpp:"Any/*'0*/".} = object
...
proc iiany(scope: Scope,
          ...
          keep_dims: bool): Any {.header:"../../ops/array/array.h", importcpp:"Any(*#, #, #, #)", constructor.}
...
type AssignAddVariableOp*{.header:"../../ops/array/array.h", importcpp:"AssignAddVariableOp/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiassignAddVariableOp(scope: Scope,
                          resource: oresource,
                          value: AssignAddVariableOpdtype): AssignAddVariableOp {.header:"../../ops/array/array.h", importcpp:"AssignAddVariableOp(*#, #, #)", constructor.}
...
type AssignSub*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"AssignSub/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiassignSub[oT: oall](scope: Scope,
                ...
                value: oT,
                T: DType,
                use_locking: bool): AssignSub[oT] {.header:"../../ops/array/array.h", importcpp:"AssignSub(*#, #, #, #, #)", constructor.}
...
type AssignSubVariableOp*{.header:"../../ops/array/array.h", importcpp:"AssignSubVariableOp/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiassignSubVariableOp(scope: Scope,
                          resource: oresource,
                          value: AssignSubVariableOpdtype): AssignSubVariableOp {.header:"../../ops/array/array.h", importcpp:"AssignSubVariableOp(*#, #, #)", constructor.}
...
type AssignVariableOp*{.header:"../../ops/array/array.h", importcpp:"AssignVariableOp/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiassignVariableOp(scope: Scope,
                       resource: oresource,
                       value: AssignVariableOpdtype): AssignVariableOp {.header:"../../ops/array/array.h", importcpp:"AssignVariableOp(*#, #, #)", constructor.}
...
type Barrier* {.header:"../../ops/array/array.h", importcpp:"Barrier/*'0*/".} = object
...
proc iibarrier(scope: Scope,
              ...
              container: cstring,
              shared_name: cstring,
              capacity: int64): Barrier {.header:"../../ops/array/array.h", importcpp:"Barrier(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type BarrierClose*{.header:"../../ops/array/array.h", importcpp:"BarrierClose/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iibarrierClose(scope: Scope,
                   handle: ostring,
                   cancel_pending_enqueues: bool): BarrierClose {.header:"../../ops/array/array.h", importcpp:"BarrierClose(*#, #, #)", constructor.}
...
type BarrierIncompleteSize* {.header:"../../ops/array/array.h", importcpp:"BarrierIncompleteSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iibarrierIncompleteSize(scope: Scope,
                            handle: ostring): BarrierIncompleteSize {.header:"../../ops/array/array.h", importcpp:"BarrierIncompleteSize(*#, #)", constructor.}
...
type BarrierInsertMany*{.header:"../../ops/array/array.h", importcpp:"BarrierInsertMany/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iibarrierInsertMany(scope: Scope,
                        ...
                        component_index: int64): BarrierInsertMany {.header:"../../ops/array/array.h", importcpp:"BarrierInsertMany(*#, #, #, #, #)", constructor.}
...
type BarrierReadySize* {.header:"../../ops/array/array.h", importcpp:"BarrierReadySize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iibarrierReadySize(scope: Scope,
                       handle: ostring): BarrierReadySize {.header:"../../ops/array/array.h", importcpp:"BarrierReadySize(*#, #)", constructor.}
...
type BarrierTakeMany* {.header:"../../ops/array/array.h", importcpp:"BarrierTakeMany/*'0*/".} = object
...
proc iibarrierTakeMany(scope: Scope,
                      ...
                      timeout_ms: int64): BarrierTakeMany {.header:"../../ops/array/array.h", importcpp:"BarrierTakeMany(*#, #, #, #, #, #, #)", constructor.}
...
type Batch*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Batch/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iibatch[oT: oall](scope: Scope,
            ...
            grad_timeout_micros: int64): Batch[oT] {.header:"../../ops/array/array.h", importcpp:"Batch(*#, #, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #, #, #, #, #)", constructor.}
...
type BatchSelfAdjointEigV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"BatchSelfAdjointEigV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibatchSelfAdjointEigV2[oT: oall](scope: Scope,
                            input: oT,
                            compute_v: bool,
                            T: DType): BatchSelfAdjointEigV2[oT] {.header:"../../ops/array/array.h", importcpp:"BatchSelfAdjointEigV2(*#, #, #, #)", constructor.}
...
type BatchToSpaceND*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"BatchToSpaceND/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibatchToSpaceND[oT: oall](scope: Scope,
                     ...
                     T: DType): BatchToSpaceND[oT] {.header:"../../ops/array/array.h", importcpp:"BatchToSpaceND(*#, #, #, #, #)", constructor.}
...
type Bincount*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Bincount/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibincount[oT: oall](scope: Scope,
               ...
               size: oint32,
               weights: oT,
               T: DType): Bincount[oT] {.header:"../../ops/array/array.h", importcpp:"Bincount(*#, #, #, #, #)", constructor.}
...
type Bucketize* {.header:"../../ops/array/array.h", importcpp:"Bucketize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iibucketize(scope: Scope,
                input: BucketizeT,
                boundaries: ArraySlice[float32]): Bucketize {.header:"../../ops/array/array.h", importcpp:"Bucketize(*#, #, #)", constructor.}
...
type Cast*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Cast/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iincast[oT: oall](scope: Scope,
            ...
            Truncate: bool,
            DstT: DType,
            explicitT: type(oT)): Cast[oT] {.header:"../../ops/array/array.h", importcpp:"Cast(*#, #, #, #)", constructor.}
...
type CollectiveBcastSend*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"CollectiveBcastSend/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iicollectiveBcastSend[oT: oall](scope: Scope,
                          ...
                          group_key: int64,
                          instance_key: int64,
                          shape: TensorShape): CollectiveBcastSend[oT] {.header:"../../ops/array/array.h", importcpp:"CollectiveBcastSend(*#, #, #, #, #, #, #)", constructor.}
...
type CollectiveReduce*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"CollectiveReduce/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iicollectiveReduce[oT: oall](scope: Scope,
                       ...
                       group_size: int64,
                       group_key: int64,
                       instance_key: int64): CollectiveReduce[oT] {.header:"../../ops/array/array.h", importcpp:"CollectiveReduce(*#, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type CompareAndBitpack* {.header:"../../ops/array/array.h", importcpp:"CompareAndBitpack/*'0*/".} = object
  operation*: Operation[ouint8]
  output*: ouint8

proc iicompareAndBitpack(scope: Scope,
                        input: CompareAndBitpackT,
                        threshold: CompareAndBitpackT): CompareAndBitpack {.header:"../../ops/array/array.h", importcpp:"CompareAndBitpack(*#, #, #)", constructor.}
...
type ComputeAccidentalHits* {.header:"../../ops/array/array.h", importcpp:"ComputeAccidentalHits/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iicomputeAccidentalHits(scope: Scope,
                            ...
                            num_true: int64,
                            seed: int64,
                            seed2: int64): ComputeAccidentalHits {.header:"../../ops/array/array.h", importcpp:"ComputeAccidentalHits(*#, #, #, #, #, #)", constructor.}
...
type ConditionalAccumulator* {.header:"../../ops/array/array.h", importcpp:"ConditionalAccumulator/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iiconditionalAccumulator(scope: Scope,
                             ...
                             dtype: DType,
                             shape: TensorShape,
                             reduction_type: cstring): ConditionalAccumulator {.header:"../../ops/array/array.h", importcpp:"ConditionalAccumulator(*#, tensorflow::string(#), tensorflow::string(#), #, #, tensorflow::string(#))", constructor.}
...
type Copy*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Copy/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iicopy[oT: oall](scope: Scope,
           ...
           T: DType): Copy[oT] {.header:"../../ops/array/array.h", importcpp:"Copy(*#, #, tensorflow::string(#), #, #)", constructor.}
...
type CopyHost*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"CopyHost/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iicopyHost[oT: oall](scope: Scope,
               ...
               tensor_name: cstring,
               debug_ops_spec: ArraySlice[cstring],
               T: DType): CopyHost[oT] {.header:"../../ops/array/array.h", importcpp:"CopyHost(*#, #, tensorflow::string(#), #, #)", constructor.}
...
type DataFormatDimMap*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"DataFormatDimMap/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidataFormatDimMap[oT: oall](scope: Scope,
                       ...
                       T: DType,
                       src_format: cstring,
                       dst_format: cstring): DataFormatDimMap[oT] {.header:"../../ops/array/array.h", importcpp:"DataFormatDimMap(*#, #, #, tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type DecodeProtoV2* {.header:"../../ops/array/array.h", importcpp:"DecodeProtoV2/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iidecodeProtoV2(scope: Scope,
                    ...
                    sanitize: bool): DecodeProtoV2 {.header:"../../ops/array/array.h", importcpp:"DecodeProtoV2(*#, #, tensorflow::string(#), #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type DeepCopy*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"DeepCopy/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iideepCopy[oT: oall](scope: Scope,
               x: oT,
               T: DType): DeepCopy[oT] {.header:"../../ops/array/array.h", importcpp:"DeepCopy(*#, #, #)", constructor.}
...
type DeleteSessionTensor*{.header:"../../ops/array/array.h", importcpp:"DeleteSessionTensor/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iideleteSessionTensor(scope: Scope,
                          handle: ostring): DeleteSessionTensor {.header:"../../ops/array/array.h", importcpp:"DeleteSessionTensor(*#, #)", constructor.}
...
type DenseToDenseSetOperation* {.header:"../../ops/array/array.h", importcpp:"DenseToDenseSetOperation/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iidenseToDenseSetOperation(scope: Scope,
                               ...
                               validate_indices: bool): DenseToDenseSetOperation {.header:"../../ops/array/array.h", importcpp:"DenseToDenseSetOperation(*#, #, #, tensorflow::string(#), #)", constructor.}
...
type DenseToSparseSetOperation* {.header:"../../ops/array/array.h", importcpp:"DenseToSparseSetOperation/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iidenseToSparseSetOperation(scope: Scope,
                                ...
                                set2_shape: oint64,
                                set_operation: cstring,
                                validate_indices: bool): DenseToSparseSetOperation {.header:"../../ops/array/array.h", importcpp:"DenseToSparseSetOperation(*#, #, #, #, #, tensorflow::string(#), #)", constructor.}
...
type DepthToSpace*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"DepthToSpace/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidepthToSpace[oT: oall](scope: Scope,
                   ...
                   T: DType,
                   block_size: int64,
                   data_format: cstring): DepthToSpace[oT] {.header:"../../ops/array/array.h", importcpp:"DepthToSpace(*#, #, #, #, tensorflow::string(#))", constructor.}
...
type DeserializeManySparse* {.header:"../../ops/array/array.h", importcpp:"DeserializeManySparse/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iideserializeManySparse(scope: Scope,
                            serialized_sparse: ostring,
                            dtype: DType): DeserializeManySparse {.header:"../../ops/array/array.h", importcpp:"DeserializeManySparse(*#, #, #)", constructor.}
...
type DestroyResourceOp*{.header:"../../ops/array/array.h", importcpp:"DestroyResourceOp/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iidestroyResourceOp(scope: Scope,
                        resource: oresource,
                        ignore_lookup_error: bool): DestroyResourceOp {.header:"../../ops/array/array.h", importcpp:"DestroyResourceOp(*#, #, #)", constructor.}
...
type DestroyTemporaryVariable*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"DestroyTemporaryVariable/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidestroyTemporaryVariable[oT: oall](scope: Scope,
                               nref: oT,
                               var_name: cstring,
                               T: DType): DestroyTemporaryVariable[oT] {.header:"../../ops/array/array.h", importcpp:"DestroyTemporaryVariable(*#, #, tensorflow::string(#), #)", constructor.}
...
type EmptyTensorList* {.header:"../../ops/array/array.h", importcpp:"EmptyTensorList/*'0*/".} = object
...
proc iiemptyTensorList(scope: Scope,
                      ...
                      element_dtype: DType): EmptyTensorList {.header:"../../ops/array/array.h", importcpp:"EmptyTensorList(*#, #, #, #)", constructor.}
...
type EncodeProto* {.header:"../../ops/array/array.h", importcpp:"EncodeProto/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iiencodeProto(scope: Scope,
                  ...
                  descriptor_source: cstring): EncodeProto {.header:"../../ops/array/array.h", importcpp:"EncodeProto(*#, #, #, #, tensorflow::string(#), #, tensorflow::string(#))", constructor.}
...
type ExperimentalThreadPoolHandle* {.header:"../../ops/array/array.h", importcpp:"ExperimentalThreadPoolHandle/*'0*/".} = object
...
proc iiexperimentalThreadPoolHandle(scope: Scope,
                                   ...
                                   shared_name: cstring,
                                   num_threads: int64,
                                   max_intra_op_parallelism: int64): ExperimentalThreadPoolHandle {.header:"../../ops/array/array.h", importcpp:"ExperimentalThreadPoolHandle(*#, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type FakeQuantWithMinMaxArgs* {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxArgs/*'0*/".} = object
...
proc iifakeQuantWithMinMaxArgs(scope: Scope,
                              ...
                              max: float32,
                              num_bits: int64,
                              narrow_range: bool): FakeQuantWithMinMaxArgs {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxArgs(*#, #, #, #, #, #)", constructor.}
...
type FakeQuantWithMinMaxArgsGradient* {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxArgsGradient/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iifakeQuantWithMinMaxArgsGradient(scope: Scope,
                                      ...
                                      max: float32,
                                      num_bits: int64,
                                      narrow_range: bool): FakeQuantWithMinMaxArgsGradient {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxArgsGradient(*#, #, #, #, #, #, #)", constructor.}
...
type FakeQuantWithMinMaxVars* {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVars/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iifakeQuantWithMinMaxVars(scope: Scope,
                              ...
                              max: ofloat,
                              num_bits: int64,
                              narrow_range: bool): FakeQuantWithMinMaxVars {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVars(*#, #, #, #, #, #)", constructor.}
...
type FakeQuantWithMinMaxVarsGradient* {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVarsGradient/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iifakeQuantWithMinMaxVarsGradient(scope: Scope,
                                      ...
                                      max: ofloat,
                                      num_bits: int64,
                                      narrow_range: bool): FakeQuantWithMinMaxVarsGradient {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVarsGradient(*#, #, #, #, #, #, #)", constructor.}
...
type FakeQuantWithMinMaxVarsPerChannel* {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVarsPerChannel/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iifakeQuantWithMinMaxVarsPerChannel(scope: Scope,
                                        ...
                                        max: ofloat,
                                        num_bits: int64,
                                        narrow_range: bool): FakeQuantWithMinMaxVarsPerChannel {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVarsPerChannel(*#, #, #, #, #, #)", constructor.}
...
type FakeQuantWithMinMaxVarsPerChannelGradient* {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVarsPerChannelGradient/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iifakeQuantWithMinMaxVarsPerChannelGradient(scope: Scope,
                                                ...
                                                max: ofloat,
                                                num_bits: int64,
                                                narrow_range: bool): FakeQuantWithMinMaxVarsPerChannelGradient {.header:"../../ops/array/array.h", importcpp:"FakeQuantWithMinMaxVarsPerChannelGradient(*#, #, #, #, #, #, #)", constructor.}
...
type FusedBatchNormGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"FusedBatchNormGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iifusedBatchNormGrad[oT: oall](scope: Scope,
                         ...
                         epsilon: float32,
                         data_format: cstring,
                         is_training: bool): FusedBatchNormGrad[oT] {.header:"../../ops/array/array.h", importcpp:"FusedBatchNormGrad(*#, #, #, #, #, #, #, #, tensorflow::string(#), #)", constructor.}
...
type FusedBatchNormGradV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"FusedBatchNormGradV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iifusedBatchNormGradV2[oT: oall](scope: Scope,
                           ...
                           is_training: bool,
                           epsilon: float32,
                           data_format: cstring): FusedBatchNormGradV2[oT] {.header:"../../ops/array/array.h", importcpp:"FusedBatchNormGradV2(*#, #, #, #, #, #, #, #, #, tensorflow::string(#))", constructor.}
...
type GatherV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"GatherV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iigatherV2[oT: oall](scope: Scope,
               ...
               axis: GatherV2Taxis,
               Tparams: DType): GatherV2[oT] {.header:"../../ops/array/array.h", importcpp:"GatherV2(*#, #, #, #, #)", constructor.}
...
type GetSessionHandle* {.header:"../../ops/array/array.h", importcpp:"GetSessionHandle/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iigetSessionHandle(scope: Scope,
                       value: GetSessionHandleT): GetSessionHandle {.header:"../../ops/array/array.h", importcpp:"GetSessionHandle(*#, #)", constructor.}
...
type GetSessionHandleV2* {.header:"../../ops/array/array.h", importcpp:"GetSessionHandleV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource

proc iigetSessionHandleV2(scope: Scope,
                         value: GetSessionHandleV2T): GetSessionHandleV2 {.header:"../../ops/array/array.h", importcpp:"GetSessionHandleV2(*#, #)", constructor.}
...
type GetSessionTensor*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"GetSessionTensor/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iigetSessionTensor[oT: oall](scope: Scope,
                       handle: ostring,
                       dtype: DType,
                       explicitT: type(oT)): GetSessionTensor[oT] {.header:"../../ops/array/array.h", importcpp:"GetSessionTensor(*#, #, #)", constructor.}
...
type HostConst*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"HostConst/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iihostConst[oT: oall](scope: Scope,
                value: Tensor[oT],
                dtype: DType): HostConst[oT] {.header:"../../ops/array/array.h", importcpp:"HostConst(*#, *#, #)", constructor.}
...
type ImmutableConst*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ImmutableConst/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiimmutableConst[oT: oall](scope: Scope,
                     ...
                     dtype: DType,
                     shape: TensorShape,
                     explicitT: type(oT)): ImmutableConst[oT] {.header:"../../ops/array/array.h", importcpp:"ImmutableConst(*#, tensorflow::string(#), #, #)", constructor.}
...
type InplaceUpdate*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"InplaceUpdate/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiinplaceUpdate[oT: oall](scope: Scope,
                    ...
                    i: oint32,
                    v: oT,
                    T: DType): InplaceUpdate[oT] {.header:"../../ops/array/array.h", importcpp:"InplaceUpdate(*#, #, #, #, #)", constructor.}
...
type InvertPermutation*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"InvertPermutation/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iiinvertPermutation[oT: oall](scope: Scope,
                        x: oT,
                        T: DType): InvertPermutation[oT] {.header:"../../ops/array/array.h", importcpp:"InvertPermutation(*#, #, #)", constructor.}
...
type IsVariableInitialized* {.header:"../../ops/array/array.h", importcpp:"IsVariableInitialized/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iiisVariableInitialized(scope: Scope,
                            nref: IsVariableInitializeddtype): IsVariableInitialized {.header:"../../ops/array/array.h", importcpp:"IsVariableInitialized(*#, #)", constructor.}
...
type ListDiff*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ListDiff/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iilistDiff[oT: oall](scope: Scope,
               ...
               y: oT,
               T: DType,
               out_idx: DType): ListDiff[oT] {.header:"../../ops/array/array.h", importcpp:"ListDiff(*#, #, #, #, #)", constructor.}
...
type LoadAndRemapMatrix* {.header:"../../ops/array/array.h", importcpp:"LoadAndRemapMatrix/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iiloadAndRemapMatrix(scope: Scope,
                         ...
                         num_rows: int64,
                         num_cols: int64,
                         max_rows_in_memory: int64): LoadAndRemapMatrix {.header:"../../ops/array/array.h", importcpp:"LoadAndRemapMatrix(*#, #, #, #, #, #, #, #, #)", constructor.}
...
type MirrorPad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"MirrorPad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iimirrorPad[oT: oall](scope: Scope,
                ...
                mode: cstring,
                T: DType): MirrorPad[oT] {.header:"../../ops/array/array.h", importcpp:"MirrorPad(*#, #, #, tensorflow::string(#), #)", constructor.}
...
type MutableHashTableV2* {.header:"../../ops/array/array.h", importcpp:"MutableHashTableV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iimutableHashTableV2(scope: Scope,
                         ...
                         key_dtype: DType,
                         value_dtype: DType): MutableHashTableV2 {.header:"../../ops/array/array.h", importcpp:"MutableHashTableV2(*#, tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type NcclReduce*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"NcclReduce/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iincclReduce[oT: oall](scope: Scope,
                 ...
                 reduction: cstring,
                 T: DType,
                 num_devices: int64): NcclReduce[oT] {.header:"../../ops/array/array.h", importcpp:"NcclReduce(*#, #, tensorflow::string(#), #, #)", constructor.}
...
type NoOp*{.header:"../../ops/array/array.h", importcpp:"NoOp/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iinoOp(scope: Scope): NoOp {.header:"../../ops/array/array.h", importcpp:"NoOp(*#)", constructor.}
...
type NonMaxSuppressionV3* {.header:"../../ops/array/array.h", importcpp:"NonMaxSuppressionV3/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iinonMaxSuppressionV3(scope: Scope,
                          ...
                          score_threshold: ofloat): NonMaxSuppressionV3 {.header:"../../ops/array/array.h", importcpp:"NonMaxSuppressionV3(*#, #, #, #, #, #)", constructor.}
...
type NonMaxSuppressionV4* {.header:"../../ops/array/array.h", importcpp:"NonMaxSuppressionV4/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iinonMaxSuppressionV4(scope: Scope,
                          ...
                          pad_to_max_output_size: bool): NonMaxSuppressionV4 {.header:"../../ops/array/array.h", importcpp:"NonMaxSuppressionV4(*#, #, #, #, #, #, #)", constructor.}
...
type NonMaxSuppressionWithOverlaps* {.header:"../../ops/array/array.h", importcpp:"NonMaxSuppressionWithOverlaps/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iinonMaxSuppressionWithOverlaps(scope: Scope,
                                    ...
                                    score_threshold: ofloat): NonMaxSuppressionWithOverlaps {.header:"../../ops/array/array.h", importcpp:"NonMaxSuppressionWithOverlaps(*#, #, #, #, #, #)", constructor.}
...
type NthElement*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"NthElement/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iinthElement[oT: oall](scope: Scope,
                 ...
                 n: oint32,
                 reverse: bool,
                 T: DType): NthElement[oT] {.header:"../../ops/array/array.h", importcpp:"NthElement(*#, #, #, #, #)", constructor.}
...
type OneHot*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"OneHot/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iioneHot[oT: oall](scope: Scope,
             ...
             off_value: oT,
             axis: int64,
             T: DType): OneHot[oT] {.header:"../../ops/array/array.h", importcpp:"OneHot(*#, #, #, #, #, #, #)", constructor.}
...
type OptionalFromValue* {.header:"../../ops/array/array.h", importcpp:"OptionalFromValue/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iioptionalFromValue(scope: Scope,
                        components: olist[oall],
                        Toutput_types: ArraySlice[DType]): OptionalFromValue {.header:"../../ops/array/array.h", importcpp:"OptionalFromValue(*#, #, #)", constructor.}
...
type OptionalGetValue*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"OptionalGetValue/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iioptionalGetValue[oT: oall](scope: Scope,
                       ...
                       explicitT: type(oT)): OptionalGetValue[oT] {.header:"../../ops/array/array.h", importcpp:"OptionalGetValue(*#, #, #, #)", constructor.}
...
type OptionalHasValue* {.header:"../../ops/array/array.h", importcpp:"OptionalHasValue/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iioptionalHasValue(scope: Scope,
                       optional: ovariant): OptionalHasValue {.header:"../../ops/array/array.h", importcpp:"OptionalHasValue(*#, #)", constructor.}
...
type OptionalNone* {.header:"../../ops/array/array.h", importcpp:"OptionalNone/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iioptionalNone(scope: Scope): OptionalNone {.header:"../../ops/array/array.h", importcpp:"OptionalNone(*#)", constructor.}
...
type Pack*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Pack/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iipack[oT: oall](scope: Scope,
           values: olist[oT],
           T: DType,
           axis: int64): Pack[oT] {.header:"../../ops/array/array.h", importcpp:"Pack(*#, #, #, #)", constructor.}
...
type PaddedBatchDataset* {.header:"../../ops/array/array.h", importcpp:"PaddedBatchDataset/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iipaddedBatchDataset(scope: Scope,
                         ...
                         output_shapes: ArraySlice[TensorShape]): PaddedBatchDataset {.header:"../../ops/array/array.h", importcpp:"PaddedBatchDataset(*#, #, #, #, #, #, #)", constructor.}
...
type ParallelConcat*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ParallelConcat/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiparallelConcat[oT: oall](scope: Scope,
                     values: olist[oT],
                     T: DType,
                     shape: TensorShape): ParallelConcat[oT] {.header:"../../ops/array/array.h", importcpp:"ParallelConcat(*#, #, #, #)", constructor.}
...
type PlaceholderV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"PlaceholderV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiplaceholderV2[oT: oall](scope: Scope,
                    dtype: DType,
                    shape: TensorShape,
                    explicitT: type(oT)): PlaceholderV2[oT] {.header:"../../ops/array/array.h", importcpp:"PlaceholderV2(*#, #, #)", constructor.}
...
type PlaceholderWithDefault*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"PlaceholderWithDefault/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiplaceholderWithDefault[oT: oall](scope: Scope,
                             input: oT,
                             dtype: DType,
                             shape: TensorShape): PlaceholderWithDefault[oT] {.header:"../../ops/array/array.h", importcpp:"PlaceholderWithDefault(*#, #, #, #)", constructor.}
...
type PopulationCount* {.header:"../../ops/array/array.h", importcpp:"PopulationCount/*'0*/".} = object
  operation*: Operation[ouint8]
  output*: ouint8

proc iipopulationCount(scope: Scope,
                      x: PopulationCountT): PopulationCount {.header:"../../ops/array/array.h", importcpp:"PopulationCount(*#, #)", constructor.}
...
type PrintV2*{.header:"../../ops/array/array.h", importcpp:"PrintV2/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiprintV2(scope: Scope,
              input: ostring,
              output_stream: cstring): PrintV2 {.header:"../../ops/array/array.h", importcpp:"PrintV2(*#, #, tensorflow::string(#))", constructor.}
...
type QuantizeAndDequantize*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"QuantizeAndDequantize/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizeAndDequantize[oT: oall](scope: Scope,
                            ...
                            input_min: float32,
                            input_max: float32,
                            T: DType): QuantizeAndDequantize[oT] {.header:"../../ops/array/array.h", importcpp:"QuantizeAndDequantize(*#, #, #, #, #, #, #, #)", constructor.}
...
type QuantizeAndDequantizeV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"QuantizeAndDequantizeV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizeAndDequantizeV2[oT: oall](scope: Scope,
                              ...
                              range_given: bool,
                              T: DType,
                              round_mode: cstring): QuantizeAndDequantizeV2[oT] {.header:"../../ops/array/array.h", importcpp:"QuantizeAndDequantizeV2(*#, #, #, #, #, #, #, #, tensorflow::string(#))", constructor.}
...
type QuantizeAndDequantizeV3*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"QuantizeAndDequantizeV3/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizeAndDequantizeV3[oT: oall](scope: Scope,
                              ...
                              signed_input: bool,
                              range_given: bool,
                              T: DType): QuantizeAndDequantizeV3[oT] {.header:"../../ops/array/array.h", importcpp:"QuantizeAndDequantizeV3(*#, #, #, #, #, #, #, #)", constructor.}
...
type QuantizeDownAndShrinkRange*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"QuantizeDownAndShrinkRange/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizeDownAndShrinkRange[oT: oall](scope: Scope,
                                 ...
                                 input_max: ofloat,
                                 out_type: DType,
                                 explicitT: type(oT)): QuantizeDownAndShrinkRange[oT] {.header:"../../ops/array/array.h", importcpp:"QuantizeDownAndShrinkRange(*#, #, #, #, #)", constructor.}
...
type QuantizedConcat*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"QuantizedConcat/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizedConcat[oT: oall](scope: Scope,
                      ...
                      T: DType): QuantizedConcat[oT] {.header:"../../ops/array/array.h", importcpp:"QuantizedConcat(*#, #, #, #, #, #)", constructor.}
...
type QuantizedReshape*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"QuantizedReshape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizedReshape[oT: oall](scope: Scope,
                       ...
                       input_min: ofloat,
                       input_max: ofloat,
                       T: DType): QuantizedReshape[oT] {.header:"../../ops/array/array.h", importcpp:"QuantizedReshape(*#, #, #, #, #, #)", constructor.}
...
type RaggedGather* {.header:"../../ops/array/array.h", importcpp:"RaggedGather/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiraggedGather(scope: Scope,
                   ...
                   PARAMS_RAGGED_RANK: int64): RaggedGather {.header:"../../ops/array/array.h", importcpp:"RaggedGather(*#, #, #, #, #, #)", constructor.}
...
type RefMerge*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"RefMerge/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iirefMerge[oT: oall](scope: Scope,
               inputs: olist[oT],
               T: DType): RefMerge[oT] {.header:"../../ops/array/array.h", importcpp:"RefMerge(*#, #, #)", constructor.}
...
type ResourceGather*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ResourceGather/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiresourceGather[oT: oall](scope: Scope,
                     ...
                     dtype: DType,
                     explicitT: type(oT)): ResourceGather[oT] {.header:"../../ops/array/array.h", importcpp:"ResourceGather(*#, #, #, #, #)", constructor.}
...
type ResourceScatterMax*{.header:"../../ops/array/array.h", importcpp:"ResourceScatterMax/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiresourceScatterMax(scope: Scope,
                         ...
                         updates: ResourceScatterMaxdtype): ResourceScatterMax {.header:"../../ops/array/array.h", importcpp:"ResourceScatterMax(*#, #, #, #)", constructor.}
...
type ResourceScatterMin*{.header:"../../ops/array/array.h", importcpp:"ResourceScatterMin/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiresourceScatterMin(scope: Scope,
                         ...
                         updates: ResourceScatterMindtype): ResourceScatterMin {.header:"../../ops/array/array.h", importcpp:"ResourceScatterMin(*#, #, #, #)", constructor.}
...
type ResourceScatterNdUpdate*{.header:"../../ops/array/array.h", importcpp:"ResourceScatterNdUpdate/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiresourceScatterNdUpdate(scope: Scope,
                              ...
                              use_locking: bool): ResourceScatterNdUpdate {.header:"../../ops/array/array.h", importcpp:"ResourceScatterNdUpdate(*#, #, #, #, #)", constructor.}
...
type ResourceScatterUpdate*{.header:"../../ops/array/array.h", importcpp:"ResourceScatterUpdate/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiresourceScatterUpdate(scope: Scope,
                            ...
                            updates: ResourceScatterUpdatedtype): ResourceScatterUpdate {.header:"../../ops/array/array.h", importcpp:"ResourceScatterUpdate(*#, #, #, #)", constructor.}
...
type ResourceStridedSliceAssign*{.header:"../../ops/array/array.h", importcpp:"ResourceStridedSliceAssign/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiresourceStridedSliceAssign(scope: Scope,
                                 ...
                                 begin_mask: int64,
                                 end_mask: int64,
                                 ellipsis_mask: int64): ResourceStridedSliceAssign {.header:"../../ops/array/array.h", importcpp:"ResourceStridedSliceAssign(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ReverseSequence*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ReverseSequence/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iireverseSequence[oT: oall](scope: Scope,
                      ...
                      seq_dim: int64,
                      batch_dim: int64,
                      T: DType): ReverseSequence[oT] {.header:"../../ops/array/array.h", importcpp:"ReverseSequence(*#, #, #, #, #, #)", constructor.}
...
type ReverseV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ReverseV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iireverseV2[oT: oall](scope: Scope,
                tensor: oT,
                axis: ReverseV2Tidx,
                T: DType): ReverseV2[oT] {.header:"../../ops/array/array.h", importcpp:"ReverseV2(*#, #, #, #)", constructor.}
...
type ScatterNdSub*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ScatterNdSub/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiscatterNdSub[oT: oall](scope: Scope,
                   ...
                   updates: oT,
                   T: DType,
                   use_locking: bool): ScatterNdSub[oT] {.header:"../../ops/array/array.h", importcpp:"ScatterNdSub(*#, #, #, #, #, #)", constructor.}
...
type ScatterNdUpdate*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ScatterNdUpdate/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiscatterNdUpdate[oT: oall](scope: Scope,
                      ...
                      updates: oT,
                      T: DType,
                      use_locking: bool): ScatterNdUpdate[oT] {.header:"../../ops/array/array.h", importcpp:"ScatterNdUpdate(*#, #, #, #, #, #)", constructor.}
...
type ScatterUpdate*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"ScatterUpdate/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiscatterUpdate[oT: oall](scope: Scope,
                    ...
                    updates: oT,
                    T: DType,
                    use_locking: bool): ScatterUpdate[oT] {.header:"../../ops/array/array.h", importcpp:"ScatterUpdate(*#, #, #, #, #, #)", constructor.}
...
type Select*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Select/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiselect[oT: oall](scope: Scope,
             ...
             t: oT,
             e: oT,
             T: DType): Select[oT] {.header:"../../ops/array/array.h", importcpp:"Select(*#, #, #, #, #)", constructor.}
...
type SelfAdjointEigV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SelfAdjointEigV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiselfAdjointEigV2[oT: oall](scope: Scope,
                       input: oT,
                       compute_v: bool,
                       T: DType): SelfAdjointEigV2[oT] {.header:"../../ops/array/array.h", importcpp:"SelfAdjointEigV2(*#, #, #, #)", constructor.}
...
type SerializeManySparse*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SerializeManySparse/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiserializeManySparse[oT: oall](scope: Scope,
                          ...
                          sparse_shape: oint64,
                          out_type: DType,
                          explicitT: type(oT)): SerializeManySparse[oT] {.header:"../../ops/array/array.h", importcpp:"SerializeManySparse(*#, #, #, #, #)", constructor.}
...
type SerializeSparse*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SerializeSparse/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiserializeSparse[oT: oall](scope: Scope,
                      ...
                      sparse_shape: oint64,
                      out_type: DType,
                      explicitT: type(oT)): SerializeSparse[oT] {.header:"../../ops/array/array.h", importcpp:"SerializeSparse(*#, #, #, #, #)", constructor.}
...
type SetSize* {.header:"../../ops/array/array.h", importcpp:"SetSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iisetSize(scope: Scope,
              ...
              set_values: SetSizeT,
              set_shape: oint64,
              validate_indices: bool): SetSize {.header:"../../ops/array/array.h", importcpp:"SetSize(*#, #, #, #, #)", constructor.}
...
type Skipgram* {.header:"../../ops/array/array.h", importcpp:"Skipgram/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iiskipgram(scope: Scope,
               ...
               window_size: int64,
               min_count: int64,
               subsample: float32): Skipgram {.header:"../../ops/array/array.h", importcpp:"Skipgram(*#, tensorflow::string(#), #, #, #, #)", constructor.}
...
type Snapshot*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Snapshot/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iisnapshot[oT: oall](scope: Scope,
               input: oT,
               T: DType): Snapshot[oT] {.header:"../../ops/array/array.h", importcpp:"Snapshot(*#, #, #)", constructor.}
...
type SpaceToDepth*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SpaceToDepth/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iispaceToDepth[oT: oall](scope: Scope,
                   ...
                   T: DType,
                   block_size: int64,
                   data_format: cstring): SpaceToDepth[oT] {.header:"../../ops/array/array.h", importcpp:"SpaceToDepth(*#, #, #, #, tensorflow::string(#))", constructor.}
...
type SparseAddGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseAddGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseAddGrad[oT: oall](scope: Scope,
                    ...
                    b_indices: oint64,
                    sum_indices: oint64,
                    T: DType): SparseAddGrad[oT] {.header:"../../ops/array/array.h", importcpp:"SparseAddGrad(*#, #, #, #, #, #)", constructor.}
...
type SparseConcat* {.header:"../../ops/array/array.h", importcpp:"SparseConcat/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseConcat(scope: Scope,
                   ...
                   shapes: olist[oint64],
                   concat_dim: int64): SparseConcat {.header:"../../ops/array/array.h", importcpp:"SparseConcat(*#, #, #, #, #)", constructor.}
...
type SparseConditionalAccumulator* {.header:"../../ops/array/array.h", importcpp:"SparseConditionalAccumulator/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iisparseConditionalAccumulator(scope: Scope,
                                   ...
                                   dtype: DType,
                                   shape: TensorShape,
                                   reduction_type: cstring): SparseConditionalAccumulator {.header:"../../ops/array/array.h", importcpp:"SparseConditionalAccumulator(*#, tensorflow::string(#), tensorflow::string(#), #, #, tensorflow::string(#))", constructor.}
...
type SparseCross* {.header:"../../ops/array/array.h", importcpp:"SparseCross/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseCross(scope: Scope,
                  ...
                  hash_key: int64,
                  out_type: DType,
                  internal_type: DType): SparseCross {.header:"../../ops/array/array.h", importcpp:"SparseCross(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type SparseDenseCwiseAdd*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseDenseCwiseAdd/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseDenseCwiseAdd[oT: oall](scope: Scope,
                          ...
                          sp_shape: oint64,
                          dense: oT,
                          T: DType): SparseDenseCwiseAdd[oT] {.header:"../../ops/array/array.h", importcpp:"SparseDenseCwiseAdd(*#, #, #, #, #, #)", constructor.}
...
type SparseDenseCwiseDiv*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseDenseCwiseDiv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseDenseCwiseDiv[oT: oall](scope: Scope,
                          ...
                          sp_shape: oint64,
                          dense: oT,
                          T: DType): SparseDenseCwiseDiv[oT] {.header:"../../ops/array/array.h", importcpp:"SparseDenseCwiseDiv(*#, #, #, #, #, #)", constructor.}
...
type SparseFillEmptyRows* {.header:"../../ops/array/array.h", importcpp:"SparseFillEmptyRows/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseFillEmptyRows(scope: Scope,
                          ...
                          dense_shape: oint64,
                          default_value: SparseFillEmptyRowsT): SparseFillEmptyRows {.header:"../../ops/array/array.h", importcpp:"SparseFillEmptyRows(*#, #, #, #, #)", constructor.}
...
type SparseFillEmptyRowsGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseFillEmptyRowsGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseFillEmptyRowsGrad[oT: oall](scope: Scope,
                              ...
                              grad_values: oT,
                              T: DType): SparseFillEmptyRowsGrad[oT] {.header:"../../ops/array/array.h", importcpp:"SparseFillEmptyRowsGrad(*#, #, #, #)", constructor.}
...
type SparseReduceMax*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseReduceMax/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseReduceMax[oT: oall](scope: Scope,
                      ...
                      keep_dims: bool,
                      T: DType): SparseReduceMax[oT] {.header:"../../ops/array/array.h", importcpp:"SparseReduceMax(*#, #, #, #, #, #, #)", constructor.}
...
type SparseReorder* {.header:"../../ops/array/array.h", importcpp:"SparseReorder/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseReorder(scope: Scope,
                    ...
                    input_shape: oint64): SparseReorder {.header:"../../ops/array/array.h", importcpp:"SparseReorder(*#, #, #, #)", constructor.}
...
type SparseReshape* {.header:"../../ops/array/array.h", importcpp:"SparseReshape/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseReshape(scope: Scope,
                    input_indices: oint64,
                    input_shape: oint64,
                    new_shape: oint64): SparseReshape {.header:"../../ops/array/array.h", importcpp:"SparseReshape(*#, #, #, #)", constructor.}
...
type SparseSlice* {.header:"../../ops/array/array.h", importcpp:"SparseSlice/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseSlice(scope: Scope,
                  ...
                  shape: oint64,
                  start: oint64,
                  size: oint64): SparseSlice {.header:"../../ops/array/array.h", importcpp:"SparseSlice(*#, #, #, #, #, #)", constructor.}
...
type SparseSliceGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseSliceGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseSliceGrad[oT: oall](scope: Scope,
                      ...
                      T: DType): SparseSliceGrad[oT] {.header:"../../ops/array/array.h", importcpp:"SparseSliceGrad(*#, #, #, #, #, #)", constructor.}
...
type SparseSparseMaximum* {.header:"../../ops/array/array.h", importcpp:"SparseSparseMaximum/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseSparseMaximum(scope: Scope,
                          ...
                          b_shape: oint64): SparseSparseMaximum {.header:"../../ops/array/array.h", importcpp:"SparseSparseMaximum(*#, #, #, #, #, #, #)", constructor.}
...
type SparseSparseMinimum* {.header:"../../ops/array/array.h", importcpp:"SparseSparseMinimum/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseSparseMinimum(scope: Scope,
                          ...
                          b_shape: oint64): SparseSparseMinimum {.header:"../../ops/array/array.h", importcpp:"SparseSparseMinimum(*#, #, #, #, #, #, #)", constructor.}
...
type SparseSplit* {.header:"../../ops/array/array.h", importcpp:"SparseSplit/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseSplit(scope: Scope,
                  ...
                  values: SparseSplitT,
                  shape: oint64,
                  num_split: int64): SparseSplit {.header:"../../ops/array/array.h", importcpp:"SparseSplit(*#, #, #, #, #, #)", constructor.}
...
type SparseToDense*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SparseToDense/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisparseToDense[oT: oall](scope: Scope,
                    ...
                    default_value: oT,
                    validate_indices: bool,
                    T: DType): SparseToDense[oT] {.header:"../../ops/array/array.h", importcpp:"SparseToDense(*#, #, #, #, #, #, #)", constructor.}
...
type SparseToSparseSetOperation* {.header:"../../ops/array/array.h", importcpp:"SparseToSparseSetOperation/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iisparseToSparseSetOperation(scope: Scope,
                                 ...
                                 set2_shape: oint64,
                                 set_operation: cstring,
                                 validate_indices: bool): SparseToSparseSetOperation {.header:"../../ops/array/array.h", importcpp:"SparseToSparseSetOperation(*#, #, #, #, #, #, #, tensorflow::string(#), #)", constructor.}
...
type SplitV*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"SplitV/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisplitV[oT: oall](scope: Scope,
             ...
             split_dim: oint32,
             num_split: int64,
             T: DType): SplitV[oT] {.header:"../../ops/array/array.h", importcpp:"SplitV(*#, #, #, #, #, #)", constructor.}
...
type StackPush*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"StackPush/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistackPush[oT: oall](scope: Scope,
                ...
                elem: oT,
                T: DType,
                swap_memory: bool): StackPush[oT] {.header:"../../ops/array/array.h", importcpp:"StackPush(*#, #, #, #, #)", constructor.}
...
type StackV2* {.header:"../../ops/array/array.h", importcpp:"StackV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iistackV2(scope: Scope,
              max_size: oint32,
              stack_name: cstring,
              elem_type: DType): StackV2 {.header:"../../ops/array/array.h", importcpp:"StackV2(*#, #, tensorflow::string(#), #)", constructor.}
...
type Stage*{.header:"../../ops/array/array.h", importcpp:"Stage/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iistage(scope: Scope,
            ...
            shared_name: cstring,
            capacity: int64,
            memory_limit: int64): Stage {.header:"../../ops/array/array.h", importcpp:"Stage(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type StagePeek*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"StagePeek/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iistagePeek[oT: oall](scope: Scope,
                ...
                capacity: int64,
                memory_limit: int64,
                explicitT: type(oT)): StagePeek[oT] {.header:"../../ops/array/array.h", importcpp:"StagePeek(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type StageSize* {.header:"../../ops/array/array.h", importcpp:"StageSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iistageSize(scope: Scope,
                ...
                shared_name: cstring,
                capacity: int64,
                memory_limit: int64): StageSize {.header:"../../ops/array/array.h", importcpp:"StageSize(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type StridedSliceAssign*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"StridedSliceAssign/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistridedSliceAssign[oT: oall](scope: Scope,
                         ...
                         end_mask: int64,
                         ellipsis_mask: int64,
                         new_axis_mask: int64): StridedSliceAssign[oT] {.header:"../../ops/array/array.h", importcpp:"StridedSliceAssign(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type StridedSliceGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"StridedSliceGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistridedSliceGrad[oT: oall](scope: Scope,
                       ...
                       end_mask: int64,
                       ellipsis_mask: int64,
                       new_axis_mask: int64): StridedSliceGrad[oT] {.header:"../../ops/array/array.h", importcpp:"StridedSliceGrad(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type TemporaryVariable*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TemporaryVariable/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitemporaryVariable[oT: oall](scope: Scope,
                        ...
                        shape: TensorShape,
                        dtype: DType,
                        explicitT: type(oT)): TemporaryVariable[oT] {.header:"../../ops/array/array.h", importcpp:"TemporaryVariable(*#, tensorflow::string(#), #, #)", constructor.}
...
type TensorListConcat*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorListConcat/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorListConcat[oT: oall](scope: Scope,
                       ...
                       element_dtype: DType,
                       explicitT: type(oT)): TensorListConcat[oT] {.header:"../../ops/array/array.h", importcpp:"TensorListConcat(*#, #, #)", constructor.}
...
type TensorListConcatLists* {.header:"../../ops/array/array.h", importcpp:"TensorListConcatLists/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorListConcatLists(scope: Scope,
                            input_a: ovariant,
                            input_b: ovariant,
                            element_dtype: DType): TensorListConcatLists {.header:"../../ops/array/array.h", importcpp:"TensorListConcatLists(*#, #, #, #)", constructor.}
...
type TensorListElementShape*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorListElementShape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorListElementShape[oT: oall](scope: Scope,
                             input_handle: ovariant,
                             shape_type: DType,
                             explicitT: type(oT)): TensorListElementShape[oT] {.header:"../../ops/array/array.h", importcpp:"TensorListElementShape(*#, #, #)", constructor.}
...
type TensorListFromTensor* {.header:"../../ops/array/array.h", importcpp:"TensorListFromTensor/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iitensorListFromTensor(scope: Scope,
                           tensor: TensorListFromTensorelement_dtype,
                           element_shape: TensorListFromTensorshape_type): TensorListFromTensor {.header:"../../ops/array/array.h", importcpp:"TensorListFromTensor(*#, #, #)", constructor.}
...
type TensorListGather*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorListGather/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorListGather[oT: oall](scope: Scope,
                       ...
                       indices: oint32,
                       element_dtype: DType,
                       explicitT: type(oT)): TensorListGather[oT] {.header:"../../ops/array/array.h", importcpp:"TensorListGather(*#, #, #, #)", constructor.}
...
type TensorListGetItem*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorListGetItem/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorListGetItem[oT: oall](scope: Scope,
                        ...
                        index: oint32,
                        element_dtype: DType,
                        explicitT: type(oT)): TensorListGetItem[oT] {.header:"../../ops/array/array.h", importcpp:"TensorListGetItem(*#, #, #, #)", constructor.}
...
type TensorListLength* {.header:"../../ops/array/array.h", importcpp:"TensorListLength/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iitensorListLength(scope: Scope,
                       input_handle: ovariant): TensorListLength {.header:"../../ops/array/array.h", importcpp:"TensorListLength(*#, #)", constructor.}
...
type TensorListPopBack* {.header:"../../ops/array/array.h", importcpp:"TensorListPopBack/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iitensorListPopBack(scope: Scope,
                        input_handle: ovariant,
                        element_dtype: DType): TensorListPopBack {.header:"../../ops/array/array.h", importcpp:"TensorListPopBack(*#, #, #)", constructor.}
...
type TensorListPushBack* {.header:"../../ops/array/array.h", importcpp:"TensorListPushBack/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iitensorListPushBack(scope: Scope,
                         input_handle: ovariant,
                         tensor: TensorListPushBackelement_dtype): TensorListPushBack {.header:"../../ops/array/array.h", importcpp:"TensorListPushBack(*#, #, #)", constructor.}
...
type TensorListPushBackBatch* {.header:"../../ops/array/array.h", importcpp:"TensorListPushBackBatch/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iitensorListPushBackBatch(scope: Scope,
                              input_handles: ovariant,
                              tensor: TensorListPushBackBatchelement_dtype): TensorListPushBackBatch {.header:"../../ops/array/array.h", importcpp:"TensorListPushBackBatch(*#, #, #)", constructor.}
...
type TensorListReserve* {.header:"../../ops/array/array.h", importcpp:"TensorListReserve/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorListReserve(scope: Scope,
                        ...
                        num_elements: oint32,
                        element_dtype: DType): TensorListReserve {.header:"../../ops/array/array.h", importcpp:"TensorListReserve(*#, #, #, #)", constructor.}
...
type TensorListScatter* {.header:"../../ops/array/array.h", importcpp:"TensorListScatter/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorListScatter(scope: Scope,
                        ...
                        indices: oint32,
                        element_shape: TensorListScattershape_type): TensorListScatter {.header:"../../ops/array/array.h", importcpp:"TensorListScatter(*#, #, #, #)", constructor.}
...
type TensorListSetItem* {.header:"../../ops/array/array.h", importcpp:"TensorListSetItem/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorListSetItem(scope: Scope,
                        input_handle: ovariant,
                        index: oint32,
                        item: TensorListSetItemelement_dtype): TensorListSetItem {.header:"../../ops/array/array.h", importcpp:"TensorListSetItem(*#, #, #, #)", constructor.}
...
type TensorListSplit* {.header:"../../ops/array/array.h", importcpp:"TensorListSplit/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant
...
proc iitensorListSplit(scope: Scope,
                      ...
                      lengths: oint64): TensorListSplit {.header:"../../ops/array/array.h", importcpp:"TensorListSplit(*#, #, #, #)", constructor.}
...
type TensorListStack*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorListStack/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorListStack[oT: oall](scope: Scope,
                      ...
                      element_dtype: DType,
                      num_elements: int64,
                      explicitT: type(oT)): TensorListStack[oT] {.header:"../../ops/array/array.h", importcpp:"TensorListStack(*#, #, #, #)", constructor.}
...
type TensorScatterAdd*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorScatterAdd/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorScatterAdd[oT: oall](scope: Scope,
                       ...
                       updates: oT,
                       T: DType): TensorScatterAdd[oT] {.header:"../../ops/array/array.h", importcpp:"TensorScatterAdd(*#, #, #, #, #)", constructor.}
...
type TensorScatterUpdate*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TensorScatterUpdate/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitensorScatterUpdate[oT: oall](scope: Scope,
                          ...
                          updates: oT,
                          T: DType): TensorScatterUpdate[oT] {.header:"../../ops/array/array.h", importcpp:"TensorScatterUpdate(*#, #, #, #, #)", constructor.}
...
type TileGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"TileGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitileGrad[oT: oall](scope: Scope,
               input: oT,
               multiples: oint32,
               T: DType): TileGrad[oT] {.header:"../../ops/array/array.h", importcpp:"TileGrad(*#, #, #, #)", constructor.}
...
type Unbatch*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Unbatch/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiunbatch[oT: oall](scope: Scope,
              ...
              T: DType): Unbatch[oT] {.header:"../../ops/array/array.h", importcpp:"Unbatch(*#, #, #, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type UnbatchGrad*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"UnbatchGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiunbatchGrad[oT: oall](scope: Scope,
                  ...
                  container: cstring,
                  shared_name: cstring,
                  T: DType): UnbatchGrad[oT] {.header:"../../ops/array/array.h", importcpp:"UnbatchGrad(*#, #, #, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type UniqueV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"UniqueV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiuniqueV2[oT: oall](scope: Scope,
               ...
               axis: UniqueV2Taxis,
               T: DType,
               out_idx: DType): UniqueV2[oT] {.header:"../../ops/array/array.h", importcpp:"UniqueV2(*#, #, #, #, #)", constructor.}
...
type UniqueWithCountsV2*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"UniqueWithCountsV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiuniqueWithCountsV2[oT: oall](scope: Scope,
                         ...
                         T: DType,
                         out_idx: DType): UniqueWithCountsV2[oT] {.header:"../../ops/array/array.h", importcpp:"UniqueWithCountsV2(*#, #, #, #, #)", constructor.}
...
type Unpack*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Unpack/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiunpack[oT: oall](scope: Scope,
             ...
             num: int64,
             T: DType,
             axis: int64): Unpack[oT] {.header:"../../ops/array/array.h", importcpp:"Unpack(*#, #, #, #, #)", constructor.}
...
type Unstage*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"Unstage/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiunstage[oT: oall](scope: Scope,
              ...
              capacity: int64,
              memory_limit: int64,
              explicitT: type(oT)): Unstage[oT] {.header:"../../ops/array/array.h", importcpp:"Unstage(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type VarHandleOp* {.header:"../../ops/array/array.h", importcpp:"VarHandleOp/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iivarHandleOp(scope: Scope,
                  ...
                  shared_name: cstring,
                  dtype: DType,
                  shape: TensorShape): VarHandleOp {.header:"../../ops/array/array.h", importcpp:"VarHandleOp(*#, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type VarIsInitializedOp* {.header:"../../ops/array/array.h", importcpp:"VarIsInitializedOp/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iivarIsInitializedOp(scope: Scope,
                         resource: oresource): VarIsInitializedOp {.header:"../../ops/array/array.h", importcpp:"VarIsInitializedOp(*#, #)", constructor.}
...
type VariableShape*[oT:oall] {.header:"../../ops/array/array.h", importcpp:"VariableShape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iivariableShape[oT: oall](scope: Scope,
                    input: oresource,
                    out_type: DType,
                    explicitT: type(oT)): VariableShape[oT] {.header:"../../ops/array/array.h", importcpp:"VariableShape(*#, #, #)", constructor.}
