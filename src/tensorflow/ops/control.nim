...
{.compile:"../../ops/control/control.cc".}


type Abort*{.header:"../../ops/control/control.h", importcpp:"Abort/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiabort(scope: Scope,
            error_msg: cstring,
            exit_without_error: bool): Abort {.header:"../../ops/control/control.h", importcpp:"Abort(*#, tensorflow::string(#), #)", constructor.}
...
type Assert*{.header:"../../ops/control/control.h", importcpp:"Assert/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiassert(scope: Scope,
             ...
             data: olist[oall],
             T: ArraySlice[DType],
             summarize: int64): Assert {.header:"../../ops/control/control.h", importcpp:"Assert(*#, #, #, #, #)", constructor.}
...
type CollectiveBcastRecv*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"CollectiveBcastRecv/*'0*/".} = object
...
proc iicollectiveBcastRecv[oT: oall](scope: Scope,
                          ...
                          instance_key: int64,
                          shape: TensorShape,
                          explicitT: type(oT)): CollectiveBcastRecv[oT] {.header:"../../ops/control/control.h", importcpp:"CollectiveBcastRecv(*#, #, #, #, #, #)", constructor.}
...
type ConsumeMutexLock*{.header:"../../ops/control/control.h", importcpp:"ConsumeMutexLock/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiconsumeMutexLock(scope: Scope,
                       mutex_lock: ovariant): ConsumeMutexLock {.header:"../../ops/control/control.h", importcpp:"ConsumeMutexLock(*#, #)", constructor.}
...
type ControlTrigger*{.header:"../../ops/control/control.h", importcpp:"ControlTrigger/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iicontrolTrigger(scope: Scope): ControlTrigger {.header:"../../ops/control/control.h", importcpp:"ControlTrigger(*#)", constructor.}

proc controlTrigger*(scope: Scope): ControlTrigger =
  return iicontrolTrigger(scope)


type Enter*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"Enter/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iienter[oT: oall](scope: Scope,
            ...
            T: DType,
            is_constant: bool,
            parallel_iterations: int64): Enter[oT] {.header:"../../ops/control/control.h", importcpp:"Enter(*#, #, tensorflow::string(#), #, #, #)", constructor.}
...
type Exit*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"Exit/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iiexit[oT: oall](scope: Scope,
           data: oT,
           T: DType): Exit[oT] {.header:"../../ops/control/control.h", importcpp:"Exit(*#, #, #)", constructor.}
...
type FakeParam*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"FakeParam/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iifakeParam[oT: oall](scope: Scope,
                dtype: DType,
                shape: TensorShape,
                explicitT: type(oT)): FakeParam[oT] {.header:"../../ops/control/control.h", importcpp:"FakeParam(*#, #, #)", constructor.}
...
type For*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"For/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iinfor[oT: oall](scope: Scope,
           ...
           input: olist[oT],
           T: ArraySlice[DType],
           body: NameAttrList): For[oT] {.header:"../../ops/control/control.h", importcpp:"For(*#, #, #, #, #, #, #)", constructor.}
...
type If*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"If/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iinif[oT: oall](scope: Scope,
          ...
          explicitT: type(oT)): If[oT] {.header:"../../ops/control/control.h", importcpp:"If(*#, #, #, #, #, #, #, #)", constructor.}
...
type LoopCond* {.header:"../../ops/control/control.h", importcpp:"LoopCond/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iiloopCond(scope: Scope,
               input: obool): LoopCond {.header:"../../ops/control/control.h", importcpp:"LoopCond(*#, #)", constructor.}
...
type Merge*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"Merge/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iimerge[oT: oall](scope: Scope,
            inputs: olist[oT],
            T: DType): Merge[oT] {.header:"../../ops/control/control.h", importcpp:"Merge(*#, #, #)", constructor.}
...
type MutexLock* {.header:"../../ops/control/control.h", importcpp:"MutexLock/*'0*/".} = object
  operation*: Operation[ovariant]
  output*: ovariant

proc iimutexLock(scope: Scope,
                mutex: oresource): MutexLock {.header:"../../ops/control/control.h", importcpp:"MutexLock(*#, #)", constructor.}
...
type MutexV2* {.header:"../../ops/control/control.h", importcpp:"MutexV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource

proc iimutexV2(scope: Scope,
              container: cstring,
              shared_name: cstring): MutexV2 {.header:"../../ops/control/control.h", importcpp:"MutexV2(*#, tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type PartitionedCall*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"PartitionedCall/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iipartitionedCall[oT: oall](scope: Scope,
                      ...
                      explicitT: type(oT)): PartitionedCall[oT] {.header:"../../ops/control/control.h", importcpp:"PartitionedCall(*#, #, #, #, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type PreventGradient*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"PreventGradient/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iipreventGradient[oT: oall](scope: Scope,
                      input: oT,
                      message: cstring,
                      T: DType): PreventGradient[oT] {.header:"../../ops/control/control.h", importcpp:"PreventGradient(*#, #, tensorflow::string(#), #)", constructor.}
...
type ReaderRestoreStateV2*{.header:"../../ops/control/control.h", importcpp:"ReaderRestoreStateV2/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iireaderRestoreStateV2(scope: Scope,
                           reader_handle: oresource,
                           state: ostring): ReaderRestoreStateV2 {.header:"../../ops/control/control.h", importcpp:"ReaderRestoreStateV2(*#, #, #)", constructor.}
...
type RefEnter*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"RefEnter/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirefEnter[oT: oall](scope: Scope,
               ...
               T: DType,
               is_constant: bool,
               parallel_iterations: int64): RefEnter[oT] {.header:"../../ops/control/control.h", importcpp:"RefEnter(*#, #, tensorflow::string(#), #, #, #)", constructor.}
...
type RefExit*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"RefExit/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iirefExit[oT: oall](scope: Scope,
              data: oT,
              T: DType): RefExit[oT] {.header:"../../ops/control/control.h", importcpp:"RefExit(*#, #, #)", constructor.}
...
type RefSelect*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"RefSelect/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirefSelect[oT: oall](scope: Scope,
                index: oint32,
                inputs: olist[oT],
                T: DType): RefSelect[oT] {.header:"../../ops/control/control.h", importcpp:"RefSelect(*#, #, #, #)", constructor.}
...
type RefSwitch*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"RefSwitch/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirefSwitch[oT: oall](scope: Scope,
                data: oT,
                pred: obool,
                T: DType): RefSwitch[oT] {.header:"../../ops/control/control.h", importcpp:"RefSwitch(*#, #, #, #)", constructor.}
...
type RemoteCall*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"RemoteCall/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiremoteCall[oT: oall](scope: Scope,
                 ...
                 Tout: ArraySlice[DType],
                 f: NameAttrList,
                 explicitT: type(oT)): RemoteCall[oT] {.header:"../../ops/control/control.h", importcpp:"RemoteCall(*#, #, #, #, #, #)", constructor.}
...
type RemoteFusedGraphExecute*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"RemoteFusedGraphExecute/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiremoteFusedGraphExecute[oT: oall](scope: Scope,
                              ...
                              explicitT: type(oT)): RemoteFusedGraphExecute[oT] {.header:"../../ops/control/control.h", importcpp:"RemoteFusedGraphExecute(*#, #, #, #, tensorflow::string(#))", constructor.}
...
type StageClear*{.header:"../../ops/control/control.h", importcpp:"StageClear/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iistageClear(scope: Scope,
                 ...
                 shared_name: cstring,
                 capacity: int64,
                 memory_limit: int64): StageClear {.header:"../../ops/control/control.h", importcpp:"StageClear(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type StatefulPartitionedCall*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"StatefulPartitionedCall/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iistatefulPartitionedCall[oT: oall](scope: Scope,
                              ...
                              config_proto: cstring,
                              executor_type: cstring,
                              explicitT: type(oT)): StatefulPartitionedCall[oT] {.header:"../../ops/control/control.h", importcpp:"StatefulPartitionedCall(*#, #, #, #, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#))", constructor.}
...
type StatelessIf*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"StatelessIf/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iistatelessIf[oT: oall](scope: Scope,
                  ...
                  then_branch: NameAttrList,
                  else_branch: NameAttrList,
                  explicitT: type(oT)): StatelessIf[oT] {.header:"../../ops/control/control.h", importcpp:"StatelessIf(*#, #, #, #, #, #, #)", constructor.}
...
type StatelessWhile*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"StatelessWhile/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iistatelessWhile[oT: oall](scope: Scope,
                     ...
                     T: ArraySlice[DType],
                     cond: NameAttrList,
                     body: NameAttrList): StatelessWhile[oT] {.header:"../../ops/control/control.h", importcpp:"StatelessWhile(*#, #, #, #, #)", constructor.}
...
type StopGradient*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"StopGradient/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iistopGradient[oT: oall](scope: Scope,
                   input: oT,
                   T: DType): StopGradient[oT] {.header:"../../ops/control/control.h", importcpp:"StopGradient(*#, #, #)", constructor.}
...
type Switch*[oT:oall] {.header:"../../ops/control/control.h", importcpp:"Switch/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiswitch[oT: oall](scope: Scope,
             data: oT,
             pred: obool,
             T: DType): Switch[oT] {.header:"../../ops/control/control.h", importcpp:"Switch(*#, #, #, #)", constructor.}
