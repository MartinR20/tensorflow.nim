...
{.compile:"../../ops/gen/gen.cc".}


type Assign*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Assign/*'0*/".} = object
...
proc iiassign[oT: oall](scope: Scope,
             ...
             T: DType,
             validate_shape: bool,
             use_locking: bool): Assign[oT] {.header:"../../ops/gen/gen.h", importcpp:"Assign(*#, #, #, #, #, #)", constructor.}
...
type BatchToSpace*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"BatchToSpace/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibatchToSpace[oT: oall](scope: Scope,
                   ...
                   T: DType,
                   block_size: int64): BatchToSpace[oT] {.header:"../../ops/gen/gen.h", importcpp:"BatchToSpace(*#, #, #, #, #)", constructor.}
...
type Bitcast*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Bitcast/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibitcast[oT: oall](scope: Scope,
              input: BitcastT,
              ntype: DType,
              explicitT: type(oT)): Bitcast[oT] {.header:"../../ops/gen/gen.h", importcpp:"Bitcast(*#, #, #)", constructor.}
...
type BroadcastArgs*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"BroadcastArgs/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibroadcastArgs[oT: oall](scope: Scope,
                    s0: oT,
                    s1: oT,
                    T: DType): BroadcastArgs[oT] {.header:"../../ops/gen/gen.h", importcpp:"BroadcastArgs(*#, #, #, #)", constructor.}
...
type BroadcastGradientArgs*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"BroadcastGradientArgs/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibroadcastGradientArgs[oT: oall](scope: Scope,
                            s0: oT,
                            s1: oT,
                            T: DType): BroadcastGradientArgs[oT] {.header:"../../ops/gen/gen.h", importcpp:"BroadcastGradientArgs(*#, #, #, #)", constructor.}
...
type BroadcastTo*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"BroadcastTo/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iibroadcastTo[oT: oall](scope: Scope,
                  ...
                  T: DType): BroadcastTo[oT] {.header:"../../ops/gen/gen.h", importcpp:"BroadcastTo(*#, #, #, #)", constructor.}
...
type ClipByValue*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ClipByValue/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiclipByValue[oT: oall](scope: Scope,
                  ...
                  clip_value_min: oT,
                  clip_value_max: oT,
                  T: DType): ClipByValue[oT] {.header:"../../ops/gen/gen.h", importcpp:"ClipByValue(*#, #, #, #, #)", constructor.}
...
type Concat*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Concat/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiconcat[oT: oall](scope: Scope,
             concat_dim: oint32,
             values: olist[oT],
             T: DType): Concat[oT] {.header:"../../ops/gen/gen.h", importcpp:"Concat(*#, #, #, #)", constructor.}
...
type ConcatOffset* {.header:"../../ops/gen/gen.h", importcpp:"ConcatOffset/*'0*/".} = object
  operation*: Operation[oint32]
  output*: olist[oint32]

proc iiconcatOffset(scope: Scope,
                   concat_dim: oint32,
                   shape: olist[oint32]): ConcatOffset {.header:"../../ops/gen/gen.h", importcpp:"ConcatOffset(*#, #, #)", constructor.}
...
type ConcatV2*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ConcatV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiconcatV2[oT: oall](scope: Scope,
               values: olist[oT],
               axis: ConcatV2Tidx,
               T: DType): ConcatV2[oT] {.header:"../../ops/gen/gen.h", importcpp:"ConcatV2(*#, #, #, #)", constructor.}
...
type Const*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Const/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iinconst[oT: oall](scope: Scope,
             value: Tensor[oT],
             dtype: DType): Const[oT] {.header:"../../ops/gen/gen.h", importcpp:"Const(*#, *#, #)", constructor.}
...
type DynamicPartition*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"DynamicPartition/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidynamicPartition[oT: oall](scope: Scope,
                       ...
                       T: DType): DynamicPartition[oT] {.header:"../../ops/gen/gen.h", importcpp:"DynamicPartition(*#, #, #, #, #)", constructor.}
...
type DynamicStitch*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"DynamicStitch/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidynamicStitch[oT: oall](scope: Scope,
                    ...
                    data: olist[oT],
                    T: DType): DynamicStitch[oT] {.header:"../../ops/gen/gen.h", importcpp:"DynamicStitch(*#, #, #, #)", constructor.}
...
type EditDistance* {.header:"../../ops/gen/gen.h", importcpp:"EditDistance/*'0*/".} = object
...
proc iieditDistance(scope: Scope,
                   ...
                   truth_shape: oint64,
                   normalize: bool): EditDistance {.header:"../../ops/gen/gen.h", importcpp:"EditDistance(*#, #, #, #, #, #, #, #)", constructor.}
...
type Empty*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Empty/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiempty[oT: oall](scope: Scope,
            ...
            dtype: DType,
            init: bool,
            explicitT: type(oT)): Empty[oT] {.header:"../../ops/gen/gen.h", importcpp:"Empty(*#, #, #, #)", constructor.}
...
type EnsureShape*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"EnsureShape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiensureShape[oT: oall](scope: Scope,
                  input: oT,
                  shape: TensorShape,
                  T: DType): EnsureShape[oT] {.header:"../../ops/gen/gen.h", importcpp:"EnsureShape(*#, #, #, #)", constructor.}
...
type ExpandDims*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ExpandDims/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiexpandDims[oT: oall](scope: Scope,
                 input: oT,
                 dim: ExpandDimsTdim,
                 T: DType): ExpandDims[oT] {.header:"../../ops/gen/gen.h", importcpp:"ExpandDims(*#, #, #, #)", constructor.}
...
type ExtractVolumePatches*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ExtractVolumePatches/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiextractVolumePatches[oT: oall](scope: Scope,
                           ...
                           padding: cstring,
                           T: DType): ExtractVolumePatches[oT] {.header:"../../ops/gen/gen.h", importcpp:"ExtractVolumePatches(*#, #, #, #, tensorflow::string(#), #)", constructor.}
...
type Fill*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Fill/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iifill[oT: oall](scope: Scope,
           dims: Fillindex_type,
           value: oT,
           T: DType): Fill[oT] {.header:"../../ops/gen/gen.h", importcpp:"Fill(*#, #, #, #)", constructor.}
...
type Gather*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Gather/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iigather[oT: oall](scope: Scope,
             ...
             Tparams: DType): Gather[oT] {.header:"../../ops/gen/gen.h", importcpp:"Gather(*#, #, #, #, #)", constructor.}
...
type GatherNd*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"GatherNd/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iigatherNd[oT: oall](scope: Scope,
               ...
               Tparams: DType): GatherNd[oT] {.header:"../../ops/gen/gen.h", importcpp:"GatherNd(*#, #, #, #)", constructor.}
...
type GuaranteeConst*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"GuaranteeConst/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iiguaranteeConst[oT: oall](scope: Scope,
                     input: oT,
                     T: DType): GuaranteeConst[oT] {.header:"../../ops/gen/gen.h", importcpp:"GuaranteeConst(*#, #, #)", constructor.}
...
type HistogramFixedWidth*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"HistogramFixedWidth/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iihistogramFixedWidth[oT: oall](scope: Scope,
                          ...
                          nbins: oint32,
                          dtype: DType,
                          explicitT: type(oT)): HistogramFixedWidth[oT] {.header:"../../ops/gen/gen.h", importcpp:"HistogramFixedWidth(*#, #, #, #, #)", constructor.}
...
type Identity*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Identity/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iiidentity[oT: oall](scope: Scope,
               input: oT,
               T: DType): Identity[oT] {.header:"../../ops/gen/gen.h", importcpp:"Identity(*#, #, #)", constructor.}
...
type IdentityN*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"IdentityN/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]

proc iiidentityN[oT: oall](scope: Scope,
                input: olist[oT],
                T: ArraySlice[DType]): IdentityN[oT] {.header:"../../ops/gen/gen.h", importcpp:"IdentityN(*#, #, #)", constructor.}
...
type OnesLike*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"OnesLike/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iionesLike[oT: oall](scope: Scope,
               x: oT,
               T: DType): OnesLike[oT] {.header:"../../ops/gen/gen.h", importcpp:"OnesLike(*#, #, #)", constructor.}
...
type Pad*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Pad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iipad[oT: oall](scope: Scope,
          ...
          T: DType): Pad[oT] {.header:"../../ops/gen/gen.h", importcpp:"Pad(*#, #, #, #)", constructor.}
...
type Placeholder*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Placeholder/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiplaceholder[oT: oall](scope: Scope,
                  dtype: DType,
                  shape: TensorShape,
                  explicitT: type(oT)): Placeholder[oT] {.header:"../../ops/gen/gen.h", importcpp:"Placeholder(*#, #, #)", constructor.}
...
type Print*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Print/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiprint[oT: oall](scope: Scope,
            ...
            T: DType,
            first_n: int64,
            summarize: int64): Print[oT] {.header:"../../ops/gen/gen.h", importcpp:"Print(*#, #, #, #, tensorflow::string(#), #, #, #)", constructor.}
...
type Range*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Range/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirange[oT: oall](scope: Scope,
            ...
            limit: oT,
            delta: oT,
            Tidx: DType): Range[oT] {.header:"../../ops/gen/gen.h", importcpp:"Range(*#, #, #, #, #)", constructor.}
...
type Rank* {.header:"../../ops/gen/gen.h", importcpp:"Rank/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iirank(scope: Scope,
           input: RankT): Rank {.header:"../../ops/gen/gen.h", importcpp:"Rank(*#, #)", constructor.}
...
type RealDiv*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"RealDiv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirealDiv[oT: oall](scope: Scope,
              x: oT,
              y: oT,
              T: DType): RealDiv[oT] {.header:"../../ops/gen/gen.h", importcpp:"RealDiv(*#, #, #, #)", constructor.}
...
type Reshape*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Reshape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iireshape[oT: oall](scope: Scope,
              tensor: oT,
              shape: ReshapeTshape,
              T: DType): Reshape[oT] {.header:"../../ops/gen/gen.h", importcpp:"Reshape(*#, #, #, #)", constructor.}
...
type Reverse*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Reverse/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iireverse[oT: oall](scope: Scope,
              tensor: oT,
              dims: obool,
              T: DType): Reverse[oT] {.header:"../../ops/gen/gen.h", importcpp:"Reverse(*#, #, #, #)", constructor.}
...
type Roll*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Roll/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiroll[oT: oall](scope: Scope,
           ...
           shift: RollTshift,
           axis: RollTaxis,
           T: DType): Roll[oT] {.header:"../../ops/gen/gen.h", importcpp:"Roll(*#, #, #, #, #)", constructor.}
...
type ScatterNd*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ScatterNd/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiscatterNd[oT: oall](scope: Scope,
                ...
                T: DType): ScatterNd[oT] {.header:"../../ops/gen/gen.h", importcpp:"ScatterNd(*#, #, #, #, #)", constructor.}
...
type Shape*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Shape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iishape[oT: oall](scope: Scope,
            input: ShapeT,
            out_type: DType,
            explicitT: type(oT)): Shape[oT] {.header:"../../ops/gen/gen.h", importcpp:"Shape(*#, #, #)", constructor.}
...
type ShapeN*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ShapeN/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iishapeN[oT: oall](scope: Scope,
             input: olist[ShapeNT],
             out_type: DType,
             explicitT: type(oT)): ShapeN[oT] {.header:"../../ops/gen/gen.h", importcpp:"ShapeN(*#, #, #)", constructor.}
...
type Size*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Size/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisize[oT: oall](scope: Scope,
           input: SizeT,
           out_type: DType,
           explicitT: type(oT)): Size[oT] {.header:"../../ops/gen/gen.h", importcpp:"Size(*#, #, #)", constructor.}
...
type Slice*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Slice/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iislice[oT: oall](scope: Scope,
            ...
            begin: SliceIndex,
            size: SliceIndex,
            T: DType): Slice[oT] {.header:"../../ops/gen/gen.h", importcpp:"Slice(*#, #, #, #, #)", constructor.}
...
type SpaceToBatch*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"SpaceToBatch/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iispaceToBatch[oT: oall](scope: Scope,
                   ...
                   T: DType,
                   block_size: int64): SpaceToBatch[oT] {.header:"../../ops/gen/gen.h", importcpp:"SpaceToBatch(*#, #, #, #, #)", constructor.}
...
type SpaceToBatchND*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"SpaceToBatchND/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iispaceToBatchND[oT: oall](scope: Scope,
                     ...
                     T: DType): SpaceToBatchND[oT] {.header:"../../ops/gen/gen.h", importcpp:"SpaceToBatchND(*#, #, #, #, #)", constructor.}
...
type Split*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Split/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisplit[oT: oall](scope: Scope,
            ...
            value: oT,
            num_split: int64,
            T: DType): Split[oT] {.header:"../../ops/gen/gen.h", importcpp:"Split(*#, #, #, #, #)", constructor.}
...
type Squeeze*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Squeeze/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisqueeze[oT: oall](scope: Scope,
              ...
              T: DType): Squeeze[oT] {.header:"../../ops/gen/gen.h", importcpp:"Squeeze(*#, #, #, #)", constructor.}
...
type Stack* {.header:"../../ops/gen/gen.h", importcpp:"Stack/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iistack(scope: Scope,
            stack_name: cstring,
            elem_type: DType): Stack {.header:"../../ops/gen/gen.h", importcpp:"Stack(*#, tensorflow::string(#), #)", constructor.}
...
type StridedSlice*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"StridedSlice/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistridedSlice[oT: oall](scope: Scope,
                   ...
                   end_mask: int64,
                   ellipsis_mask: int64,
                   new_axis_mask: int64): StridedSlice[oT] {.header:"../../ops/gen/gen.h", importcpp:"StridedSlice(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type Tile*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Tile/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitile[oT: oall](scope: Scope,
           ...
           T: DType): Tile[oT] {.header:"../../ops/gen/gen.h", importcpp:"Tile(*#, #, #, #)", constructor.}
...
type Timestamp* {.header:"../../ops/gen/gen.h", importcpp:"Timestamp/*'0*/".} = object
  operation*: Operation[odouble]
  output*: odouble

proc iitimestamp(scope: Scope): Timestamp {.header:"../../ops/gen/gen.h", importcpp:"Timestamp(*#)", constructor.}
...
type Transpose*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Transpose/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitranspose[oT: oall](scope: Scope,
                x: oT,
                perm: TransposeTperm,
                T: DType): Transpose[oT] {.header:"../../ops/gen/gen.h", importcpp:"Transpose(*#, #, #, #)", constructor.}
...
type TruncateDiv*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"TruncateDiv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitruncateDiv[oT: oall](scope: Scope,
                  x: oT,
                  y: oT,
                  T: DType): TruncateDiv[oT] {.header:"../../ops/gen/gen.h", importcpp:"TruncateDiv(*#, #, #, #)", constructor.}
...
type TruncateMod*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"TruncateMod/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iitruncateMod[oT: oall](scope: Scope,
                  x: oT,
                  y: oT,
                  T: DType): TruncateMod[oT] {.header:"../../ops/gen/gen.h", importcpp:"TruncateMod(*#, #, #, #)", constructor.}
...
type Unique*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Unique/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiunique[oT: oall](scope: Scope,
             x: oT,
             T: DType,
             out_idx: DType): Unique[oT] {.header:"../../ops/gen/gen.h", importcpp:"Unique(*#, #, #, #)", constructor.}
...
type UniqueWithCounts*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"UniqueWithCounts/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiuniqueWithCounts[oT: oall](scope: Scope,
                       x: oT,
                       T: DType,
                       out_idx: DType): UniqueWithCounts[oT] {.header:"../../ops/gen/gen.h", importcpp:"UniqueWithCounts(*#, #, #, #)", constructor.}
...
type UnravelIndex*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"UnravelIndex/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiunravelIndex[oT: oall](scope: Scope,
                   indices: oT,
                   dims: oT,
                   Tidx: DType): UnravelIndex[oT] {.header:"../../ops/gen/gen.h", importcpp:"UnravelIndex(*#, #, #, #)", constructor.}
...
type Variable*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"Variable/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iivariable[oT: oall](scope: Scope,
               ...
               shape: TensorShape,
               dtype: DType,
               explicitT: type(oT)): Variable[oT] {.header:"../../ops/gen/gen.h", importcpp:"Variable(*#, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type VariableV2*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"VariableV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iivariableV2[oT: oall](scope: Scope,
                 ...
                 shape: TensorShape,
                 dtype: DType,
                 explicitT: type(oT)): VariableV2[oT] {.header:"../../ops/gen/gen.h", importcpp:"VariableV2(*#, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type Where* {.header:"../../ops/gen/gen.h", importcpp:"Where/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iiwhere(scope: Scope,
            input: WhereT): Where {.header:"../../ops/gen/gen.h", importcpp:"Where(*#, #)", constructor.}
...
type While*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"While/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iinwhile[oT: oall](scope: Scope,
             ...
             cond: NameAttrList,
             body: NameAttrList,
             output_shapes: ArraySlice[TensorShape]): While[oT] {.header:"../../ops/gen/gen.h", importcpp:"While(*#, #, #, #, #, #)", constructor.}
...
type ZerosLike*[oT:oall] {.header:"../../ops/gen/gen.h", importcpp:"ZerosLike/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iizerosLike[oT: oall](scope: Scope,
                x: oT,
                T: DType): ZerosLike[oT] {.header:"../../ops/gen/gen.h", importcpp:"ZerosLike(*#, #, #)", constructor.}
