...
{.compile:"../../ops/string/string.cc".}

type AsStringT* = oint8 | oint16 | oint32 | oint64 | ocomplex64 | ocomplex128 | ofloat | odouble | obool

type AsString* {.header:"../../ops/string/string.h", importcpp:"AsString/*'0*/".} = object
...
proc iiasString(scope: Scope,
               ...
               precision: int64,
               scientific: bool,
               shortest: bool): AsString {.header:"../../ops/string/string.h", importcpp:"AsString(*#, #, tensorflow::string(#), #, #, #, #)", constructor.}
...
type DecodeBase64* {.header:"../../ops/string/string.h", importcpp:"DecodeBase64/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iidecodeBase64(scope: Scope,
                   input: ostring): DecodeBase64 {.header:"../../ops/string/string.h", importcpp:"DecodeBase64(*#, #)", constructor.}
...
type DecodeCompressed* {.header:"../../ops/string/string.h", importcpp:"DecodeCompressed/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iidecodeCompressed(scope: Scope,
                       bytes: ostring,
                       compression_type: cstring): DecodeCompressed {.header:"../../ops/string/string.h", importcpp:"DecodeCompressed(*#, #, tensorflow::string(#))", constructor.}
...
type EncodeBase64* {.header:"../../ops/string/string.h", importcpp:"EncodeBase64/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iiencodeBase64(scope: Scope,
                   input: ostring,
                   pad: bool): EncodeBase64 {.header:"../../ops/string/string.h", importcpp:"EncodeBase64(*#, #, #)", constructor.}
...
type ParseTensor*[oT:oall] {.header:"../../ops/string/string.h", importcpp:"ParseTensor/*'0*/".} = object
...
proc iiparseTensor[oT: oall](scope: Scope,
                  serialized: ostring,
                  out_type: DType,
                  explicitT: type(oT)): ParseTensor[oT] {.header:"../../ops/string/string.h", importcpp:"ParseTensor(*#, #, #)", constructor.}
...
type ReaderSerializeStateV2* {.header:"../../ops/string/string.h", importcpp:"ReaderSerializeStateV2/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iireaderSerializeStateV2(scope: Scope,
                             reader_handle: oresource): ReaderSerializeStateV2 {.header:"../../ops/string/string.h", importcpp:"ReaderSerializeStateV2(*#, #)", constructor.}
...
type ReduceJoin* {.header:"../../ops/string/string.h", importcpp:"ReduceJoin/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iireduceJoin(scope: Scope,
                 ...
                 separator: cstring,
                 keep_dims: bool): ReduceJoin {.header:"../../ops/string/string.h", importcpp:"ReduceJoin(*#, #, #, tensorflow::string(#), #)", constructor.}
...
type RegexFullMatch* {.header:"../../ops/string/string.h", importcpp:"RegexFullMatch/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iiregexFullMatch(scope: Scope,
                     input: ostring,
                     pattern: ostring): RegexFullMatch {.header:"../../ops/string/string.h", importcpp:"RegexFullMatch(*#, #, #)", constructor.}
...
type RegexReplace* {.header:"../../ops/string/string.h", importcpp:"RegexReplace/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iiregexReplace(scope: Scope,
                   ...
                   pattern: ostring,
                   rewrite: ostring,
                   replace_global: bool): RegexReplace {.header:"../../ops/string/string.h", importcpp:"RegexReplace(*#, #, #, #, #)", constructor.}
...
type SerializeTensor* {.header:"../../ops/string/string.h", importcpp:"SerializeTensor/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iiserializeTensor(scope: Scope,
                      tensor: SerializeTensorT): SerializeTensor {.header:"../../ops/string/string.h", importcpp:"SerializeTensor(*#, #)", constructor.}
...
type StaticRegexFullMatch* {.header:"../../ops/string/string.h", importcpp:"StaticRegexFullMatch/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iistaticRegexFullMatch(scope: Scope,
                           input: ostring,
                           pattern: cstring): StaticRegexFullMatch {.header:"../../ops/string/string.h", importcpp:"StaticRegexFullMatch(*#, #, tensorflow::string(#))", constructor.}
...
type StaticRegexReplace* {.header:"../../ops/string/string.h", importcpp:"StaticRegexReplace/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iistaticRegexReplace(scope: Scope,
                         ...
                         pattern: cstring,
                         rewrite: cstring,
                         replace_global: bool): StaticRegexReplace {.header:"../../ops/string/string.h", importcpp:"StaticRegexReplace(*#, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type StringFormat* {.header:"../../ops/string/string.h", importcpp:"StringFormat/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iistringFormat(scope: Scope,
                   ...
                   ntemplate: cstring,
                   placeholder: cstring,
                   summarize: int64): StringFormat {.header:"../../ops/string/string.h", importcpp:"StringFormat(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type StringJoin* {.header:"../../ops/string/string.h", importcpp:"StringJoin/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iistringJoin(scope: Scope,
                 inputs: olist[ostring],
                 separator: cstring): StringJoin {.header:"../../ops/string/string.h", importcpp:"StringJoin(*#, #, tensorflow::string(#))", constructor.}
...
type StringLength* {.header:"../../ops/string/string.h", importcpp:"StringLength/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iistringLength(scope: Scope,
                   input: ostring,
                   unit: cstring): StringLength {.header:"../../ops/string/string.h", importcpp:"StringLength(*#, #, tensorflow::string(#))", constructor.}
...
type StringSplit* {.header:"../../ops/string/string.h", importcpp:"StringSplit/*'0*/".} = object
...
proc iistringSplit(scope: Scope,
                  input: ostring,
                  delimiter: ostring,
                  skip_empty: bool): StringSplit {.header:"../../ops/string/string.h", importcpp:"StringSplit(*#, #, #, #)", constructor.}
...
type StringSplitV2* {.header:"../../ops/string/string.h", importcpp:"StringSplitV2/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iistringSplitV2(scope: Scope,
                    input: ostring,
                    sep: ostring,
                    maxsplit: int64): StringSplitV2 {.header:"../../ops/string/string.h", importcpp:"StringSplitV2(*#, #, #, #)", constructor.}
...
type StringStrip* {.header:"../../ops/string/string.h", importcpp:"StringStrip/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iistringStrip(scope: Scope,
                  input: ostring): StringStrip {.header:"../../ops/string/string.h", importcpp:"StringStrip(*#, #)", constructor.}
...
type StringToHashBucket* {.header:"../../ops/string/string.h", importcpp:"StringToHashBucket/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iistringToHashBucket(scope: Scope,
                         string_tensor: ostring,
                         num_buckets: int64): StringToHashBucket {.header:"../../ops/string/string.h", importcpp:"StringToHashBucket(*#, #, #)", constructor.}
...
type StringToHashBucketFast* {.header:"../../ops/string/string.h", importcpp:"StringToHashBucketFast/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iistringToHashBucketFast(scope: Scope,
                             input: ostring,
                             num_buckets: int64): StringToHashBucketFast {.header:"../../ops/string/string.h", importcpp:"StringToHashBucketFast(*#, #, #)", constructor.}
...
type StringToHashBucketStrong* {.header:"../../ops/string/string.h", importcpp:"StringToHashBucketStrong/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iistringToHashBucketStrong(scope: Scope,
                               input: ostring,
                               key: ArraySlice[int],
                               num_buckets: int64): StringToHashBucketStrong {.header:"../../ops/string/string.h", importcpp:"StringToHashBucketStrong(*#, #, #, #)", constructor.}
...
type StringToNumber*[oT:oall] {.header:"../../ops/string/string.h", importcpp:"StringToNumber/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iistringToNumber[oT: oall](scope: Scope,
                     string_tensor: ostring,
                     out_type: DType,
                     explicitT: type(oT)): StringToNumber[oT] {.header:"../../ops/string/string.h", importcpp:"StringToNumber(*#, #, #)", constructor.}
...
type Substr* {.header:"../../ops/string/string.h", importcpp:"Substr/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iisubstr(scope: Scope,
             ...
             pos: SubstrT,
             len: SubstrT,
             unit: cstring): Substr {.header:"../../ops/string/string.h", importcpp:"Substr(*#, #, #, #, tensorflow::string(#))", constructor.}
...
type UnicodeDecodeWithOffsets* {.header:"../../ops/string/string.h", importcpp:"UnicodeDecodeWithOffsets/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiunicodeDecodeWithOffsets(scope: Scope,
                               ...
                               replace_control_characters: bool): UnicodeDecodeWithOffsets {.header:"../../ops/string/string.h", importcpp:"UnicodeDecodeWithOffsets(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type UnicodeEncode* {.header:"../../ops/string/string.h", importcpp:"UnicodeEncode/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iiunicodeEncode(scope: Scope,
                    ...
                    errors: cstring,
                    replacement_char: int64): UnicodeEncode {.header:"../../ops/string/string.h", importcpp:"UnicodeEncode(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type UnicodeScript* {.header:"../../ops/string/string.h", importcpp:"UnicodeScript/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iiunicodeScript(scope: Scope,
                    input: oint32): UnicodeScript {.header:"../../ops/string/string.h", importcpp:"UnicodeScript(*#, #)", constructor.}
...
type UnicodeTranscode* {.header:"../../ops/string/string.h", importcpp:"UnicodeTranscode/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iiunicodeTranscode(scope: Scope,
                       ...
                       errors: cstring,
                       replacement_char: int64,
                       replace_control_characters: bool): UnicodeTranscode {.header:"../../ops/string/string.h", importcpp:"UnicodeTranscode(*#, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
