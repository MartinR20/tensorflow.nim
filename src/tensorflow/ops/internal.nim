...
{.compile:"../../ops/internal/internal.cc".}

type AllTidx* = oint32 | oint64

type All* {.header:"../../ops/internal/internal.h", importcpp:"All/*'0*/".} = object
...
proc iiall(scope: Scope,
          ...
          keep_dims: bool): All {.header:"../../ops/internal/internal.h", importcpp:"All(*#, #, #, #)", constructor.}
...
type BoostedTreesExampleDebugOutputs* {.header:"../../ops/internal/internal.h", importcpp:"BoostedTreesExampleDebugOutputs/*'0*/".} = object
...
proc iiboostedTreesExampleDebugOutputs(scope: Scope,
                                      ...
                                      logits_dimension: int64): BoostedTreesExampleDebugOutputs {.header:"../../ops/internal/internal.h", importcpp:"BoostedTreesExampleDebugOutputs(*#, #, #, #, #)", constructor.}
...
type DebugGradientIdentity*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"DebugGradientIdentity/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iidebugGradientIdentity[oT: oall](scope: Scope,
                            input: oT,
                            T: DType): DebugGradientIdentity[oT] {.header:"../../ops/internal/internal.h", importcpp:"DebugGradientIdentity(*#, #, #)", constructor.}
...
type DebugGradientRefIdentity*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"DebugGradientRefIdentity/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iidebugGradientRefIdentity[oT: oall](scope: Scope,
                               input: oT,
                               T: DType): DebugGradientRefIdentity[oT] {.header:"../../ops/internal/internal.h", importcpp:"DebugGradientRefIdentity(*#, #, #)", constructor.}
...
type DebugIdentity*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"DebugIdentity/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidebugIdentity[oT: oall](scope: Scope,
                    ...
                    T: DType,
                    gated_grpc: bool): DebugIdentity[oT] {.header:"../../ops/internal/internal.h", importcpp:"DebugIdentity(*#, #, tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type DebugNanCount* {.header:"../../ops/internal/internal.h", importcpp:"DebugNanCount/*'0*/".} = object
...
proc iidebugNanCount(scope: Scope,
                    ...
                    tensor_name: cstring,
                    debug_urls: ArraySlice[cstring],
                    gated_grpc: bool): DebugNanCount {.header:"../../ops/internal/internal.h", importcpp:"DebugNanCount(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type DebugNumericSummary* {.header:"../../ops/internal/internal.h", importcpp:"DebugNumericSummary/*'0*/".} = object
...
proc iidebugNumericSummary(scope: Scope,
                          ...
                          lower_bound: float32,
                          upper_bound: float32,
                          mute_if_healthy: bool): DebugNumericSummary {.header:"../../ops/internal/internal.h", importcpp:"DebugNumericSummary(*#, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type DecodeJSONExample* {.header:"../../ops/internal/internal.h", importcpp:"DecodeJSONExample/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iidecodeJSONExample(scope: Scope,
                        json_examples: ostring): DecodeJSONExample {.header:"../../ops/internal/internal.h", importcpp:"DecodeJSONExample(*#, #)", constructor.}
...
type ExperimentalParseExampleDataset* {.header:"../../ops/internal/internal.h", importcpp:"ExperimentalParseExampleDataset/*'0*/".} = object
...
proc iiexperimentalParseExampleDataset(scope: Scope,
                                      ...
                                      sloppy: bool): ExperimentalParseExampleDataset {.header:"../../ops/internal/internal.h", importcpp:"ExperimentalParseExampleDataset(*#, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type Fact* {.header:"../../ops/internal/internal.h", importcpp:"Fact/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iifact(scope: Scope): Fact {.header:"../../ops/internal/internal.h", importcpp:"Fact(*#)", constructor.}
...
type NcclAllReduce*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"NcclAllReduce/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iincclAllReduce[oT: oall](scope: Scope,
                    ...
                    shared_name: cstring,
                    T: DType,
                    num_devices: int64): NcclAllReduce[oT] {.header:"../../ops/internal/internal.h", importcpp:"NcclAllReduce(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type NcclBroadcast*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"NcclBroadcast/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iincclBroadcast[oT: oall](scope: Scope,
                    input: oT,
                    T: DType,
                    shape: TensorShape): NcclBroadcast[oT] {.header:"../../ops/internal/internal.h", importcpp:"NcclBroadcast(*#, #, #, #)", constructor.}
...
type ParseExample* {.header:"../../ops/internal/internal.h", importcpp:"ParseExample/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiparseExample(scope: Scope,
                   ...
                   dense_shapes: ArraySlice[TensorShape],
                   Nsparse: int64,
                   Ndense: int64): ParseExample {.header:"../../ops/internal/internal.h", importcpp:"ParseExample(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ParseSequenceExample* {.header:"../../ops/internal/internal.h", importcpp:"ParseSequenceExample/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiparseSequenceExample(scope: Scope,
                           ...
                           Nfeature_list_dense: int64): ParseSequenceExample {.header:"../../ops/internal/internal.h", importcpp:"ParseSequenceExample(*#, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ParseSingleExample* {.header:"../../ops/internal/internal.h", importcpp:"ParseSingleExample/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiparseSingleExample(scope: Scope,
                         ...
                         Tdense: ArraySlice[DType],
                         dense_shapes: ArraySlice[TensorShape],
                         num_sparse: int64): ParseSingleExample {.header:"../../ops/internal/internal.h", importcpp:"ParseSingleExample(*#, #, #, #, #, #, #, #, #)", constructor.}
...
type ParseSingleSequenceExample* {.header:"../../ops/internal/internal.h", importcpp:"ParseSingleSequenceExample/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
...
proc iiparseSingleSequenceExample(scope: Scope,
                                 ...
                                 Ncontext_dense: int64,
                                 Nfeature_list_sparse: int64,
                                 Nfeature_list_dense: int64): ParseSingleSequenceExample {.header:"../../ops/internal/internal.h", importcpp:"ParseSingleSequenceExample(*#, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type ReadVariableOp*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"ReadVariableOp/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iireadVariableOp[oT: oall](scope: Scope,
                     resource: oresource,
                     dtype: DType,
                     explicitT: type(oT)): ReadVariableOp[oT] {.header:"../../ops/internal/internal.h", importcpp:"ReadVariableOp(*#, #, #)", constructor.}
...
type IArg*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_Arg/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiArg[oT: oall](scope: Scope,
           T: DType,
           index: int64,
           explicitT: type(oT)): IArg[oT] {.header:"../../ops/internal/internal.h", importcpp:"_Arg(*#, #, #)", constructor.}
...
type IArrayToList*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ArrayToList/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiiArrayToList[oT: oall](scope: Scope,
                   ...
                   explicitT: type(oT)): IArrayToList[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ArrayToList(*#, #, #)", constructor.}
...
type IDeviceArg*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_DeviceArg/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiDeviceArg[oT: oall](scope: Scope,
                 T: DType,
                 index: int64,
                 explicitT: type(oT)): IDeviceArg[oT] {.header:"../../ops/internal/internal.h", importcpp:"_DeviceArg(*#, #, #)", constructor.}
...
type IDeviceRetval*{.header:"../../ops/internal/internal.h", importcpp:"_DeviceRetval/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiiDeviceRetval(scope: Scope,
                    input: IDeviceRetvalT,
                    index: int64): IDeviceRetval {.header:"../../ops/internal/internal.h", importcpp:"_DeviceRetval(*#, #, #)", constructor.}
...
type IFusedConv2D*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_FusedConv2D/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiFusedConv2D[oT: oall](scope: Scope,
                   ...
                   epsilon: float32): IFusedConv2D[oT] {.header:"../../ops/internal/internal.h", importcpp:"_FusedConv2D(*#, #, #, #, #, tensorflow::string(#), #, #, #, tensorflow::string(#), #, #)", constructor.}
...
type IHostCast*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_HostCast/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiHostCast[oT: oall](scope: Scope,
                ...
                Truncate: bool,
                DstT: DType,
                explicitT: type(oT)): IHostCast[oT] {.header:"../../ops/internal/internal.h", importcpp:"_HostCast(*#, #, #, #)", constructor.}
...
type IHostRecv*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_HostRecv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiHostRecv[oT: oall](scope: Scope,
                ...
                explicitT: type(oT)): IHostRecv[oT] {.header:"../../ops/internal/internal.h", importcpp:"_HostRecv(*#, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type IHostSend*{.header:"../../ops/internal/internal.h", importcpp:"_HostSend/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiiHostSend(scope: Scope,
                ...
                recv_device: cstring,
                client_terminated: bool,
                send_device_incarnation: int64): IHostSend {.header:"../../ops/internal/internal.h", importcpp:"_HostSend(*#, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type IIf*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_If/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiiIf[oT: oall](scope: Scope,
          ...
          explicitT: type(oT)): IIf[oT] {.header:"../../ops/internal/internal.h", importcpp:"_If(*#, #, #, #, #, #, #)", constructor.}
...
type IListToArray*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ListToArray/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiiListToArray[oT: oall](scope: Scope,
                   ...
                   Tin: ArraySlice[DType],
                   T: DType,
                   explicitT: type(oT)): IListToArray[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ListToArray(*#, #, #, #)", constructor.}
...
type IMklAdd*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_MklAdd/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiMklAdd[oT: oall](scope: Scope,
              ...
              mkl_x: ouint8,
              mkl_y: ouint8,
              T: DType): IMklAdd[oT] {.header:"../../ops/internal/internal.h", importcpp:"_MklAdd(*#, #, #, #, #, #)", constructor.}
...
type IMklMaximum*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_MklMaximum/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiMklMaximum[oT: oall](scope: Scope,
                  ...
                  mkl_x: ouint8,
                  mkl_y: ouint8,
                  T: DType): IMklMaximum[oT] {.header:"../../ops/internal/internal.h", importcpp:"_MklMaximum(*#, #, #, #, #, #)", constructor.}
...
type IMklMul*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_MklMul/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiMklMul[oT: oall](scope: Scope,
              ...
              mkl_x: ouint8,
              mkl_y: ouint8,
              T: DType): IMklMul[oT] {.header:"../../ops/internal/internal.h", importcpp:"_MklMul(*#, #, #, #, #, #)", constructor.}
...
type IMklSquaredDifference*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_MklSquaredDifference/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiMklSquaredDifference[oT: oall](scope: Scope,
                            ...
                            mkl_x: ouint8,
                            mkl_y: ouint8,
                            T: DType): IMklSquaredDifference[oT] {.header:"../../ops/internal/internal.h", importcpp:"_MklSquaredDifference(*#, #, #, #, #, #)", constructor.}
...
type IMklSub*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_MklSub/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiMklSub[oT: oall](scope: Scope,
              ...
              mkl_x: ouint8,
              mkl_y: ouint8,
              T: DType): IMklSub[oT] {.header:"../../ops/internal/internal.h", importcpp:"_MklSub(*#, #, #, #, #, #)", constructor.}
...
type INcclBroadcastRecv*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_NcclBroadcastRecv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiNcclBroadcastRecv[oT: oall](scope: Scope,
                         ...
                         T: DType,
                         num_devices: int64,
                         explicitT: type(oT)): INcclBroadcastRecv[oT] {.header:"../../ops/internal/internal.h", importcpp:"_NcclBroadcastRecv(*#, #, tensorflow::string(#), #, #)", constructor.}
...
type INcclBroadcastSend*{.header:"../../ops/internal/internal.h", importcpp:"_NcclBroadcastSend/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiiNcclBroadcastSend(scope: Scope,
                         ...
                         shared_name: cstring,
                         num_devices: int64): INcclBroadcastSend {.header:"../../ops/internal/internal.h", importcpp:"_NcclBroadcastSend(*#, #, tensorflow::string(#), #)", constructor.}
...
type INcclReduceRecv*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_NcclReduceRecv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiNcclReduceRecv[oT: oall](scope: Scope,
                      ...
                      shared_name: cstring,
                      T: DType,
                      num_devices: int64): INcclReduceRecv[oT] {.header:"../../ops/internal/internal.h", importcpp:"_NcclReduceRecv(*#, #, tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type INcclReduceSend*{.header:"../../ops/internal/internal.h", importcpp:"_NcclReduceSend/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiiNcclReduceSend(scope: Scope,
                      ...
                      reduction: cstring,
                      shared_name: cstring,
                      num_devices: int64): INcclReduceSend {.header:"../../ops/internal/internal.h", importcpp:"_NcclReduceSend(*#, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type IParallelConcatStart*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ParallelConcatStart/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiParallelConcatStart[oT: oall](scope: Scope,
                           shape: TensorShape,
                           dtype: DType,
                           explicitT: type(oT)): IParallelConcatStart[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ParallelConcatStart(*#, #, #)", constructor.}
...
type IParallelConcatUpdate*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ParallelConcatUpdate/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiParallelConcatUpdate[oT: oall](scope: Scope,
                            ...
                            update: oT,
                            T: DType,
                            loc: int64): IParallelConcatUpdate[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ParallelConcatUpdate(*#, #, #, #, #)", constructor.}
...
type IReadVariablesOp*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ReadVariablesOp/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiiReadVariablesOp[oT: oall](scope: Scope,
                       ...
                       explicitT: type(oT)): IReadVariablesOp[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ReadVariablesOp(*#, #, #)", constructor.}
...
type IRecv*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_Recv/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiRecv[oT: oall](scope: Scope,
            ...
            send_device_incarnation: int64,
            client_terminated: bool,
            explicitT: type(oT)): IRecv[oT] {.header:"../../ops/internal/internal.h", importcpp:"_Recv(*#, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #, #)", constructor.}
...
type IRetval*{.header:"../../ops/internal/internal.h", importcpp:"_Retval/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiiRetval(scope: Scope,
              input: IRetvalT,
              index: int64): IRetval {.header:"../../ops/internal/internal.h", importcpp:"_Retval(*#, #, #)", constructor.}
...
type IScopedAllocator*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ScopedAllocator/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiScopedAllocator[oT: oall](scope: Scope,
                       ...
                       explicitT: type(oT)): IScopedAllocator[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ScopedAllocator(*#, #, tensorflow::string(#), #, #, #, #)", constructor.}
...
type IScopedAllocatorConcat*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ScopedAllocatorConcat/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiScopedAllocatorConcat[oT: oall](scope: Scope,
                             ...
                             T: DType,
                             reshape: bool,
                             id: int64): IScopedAllocatorConcat[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ScopedAllocatorConcat(*#, #, #, tensorflow::string(#), #, #, #, #)", constructor.}
...
type IScopedAllocatorSplit*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_ScopedAllocatorSplit/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiiScopedAllocatorSplit[oT: oall](scope: Scope,
                            ...
                            shapes: ArraySlice[TensorShape],
                            T: DType,
                            id: int64): IScopedAllocatorSplit[oT] {.header:"../../ops/internal/internal.h", importcpp:"_ScopedAllocatorSplit(*#, #, #, tensorflow::string(#), #, #, #)", constructor.}
...
type ISend*{.header:"../../ops/internal/internal.h", importcpp:"_Send/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiiSend(scope: Scope,
            ...
            recv_device: cstring,
            client_terminated: bool,
            send_device_incarnation: int64): ISend {.header:"../../ops/internal/internal.h", importcpp:"_Send(*#, #, tensorflow::string(#), tensorflow::string(#), tensorflow::string(#), #, #)", constructor.}
...
type IUnaryOpsComposition*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_UnaryOpsComposition/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiiUnaryOpsComposition[oT: oall](scope: Scope,
                           ...
                           T: DType): IUnaryOpsComposition[oT] {.header:"../../ops/internal/internal.h", importcpp:"_UnaryOpsComposition(*#, #, #, #)", constructor.}
...
type IVarHandlesOp* {.header:"../../ops/internal/internal.h", importcpp:"_VarHandlesOp/*'0*/".} = object
...
proc iiiVarHandlesOp(scope: Scope,
                    ...
                    dtypes: ArraySlice[DType],
                    shapes: ArraySlice[TensorShape]): IVarHandlesOp {.header:"../../ops/internal/internal.h", importcpp:"_VarHandlesOp(*#, #, #, #, #)", constructor.}
...
type IWhile*[oT:oall] {.header:"../../ops/internal/internal.h", importcpp:"_While/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiiWhile[oT: oall](scope: Scope,
             ...
             T: ArraySlice[DType],
             cond: NameAttrList,
             body: NameAttrList): IWhile[oT] {.header:"../../ops/internal/internal.h", importcpp:"_While(*#, #, #, #, #)", constructor.}
