...
{.compile:"../../ops/image/image.cc".}

type AdjustContrastT* = ouint8 | oint8 | oint16 | oint32 | oint64 | ofloat | odouble

type AdjustContrast* {.header:"../../ops/image/image.h", importcpp:"AdjustContrast/*'0*/".} = object
...
proc iiadjustContrast(scope: Scope,
                     ...
                     min_value: ofloat,
                     max_value: ofloat): AdjustContrast {.header:"../../ops/image/image.h", importcpp:"AdjustContrast(*#, #, #, #, #)", constructor.}
...
type AdjustContrastv2* {.header:"../../ops/image/image.h", importcpp:"AdjustContrastv2/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat

proc iiadjustContrastv2(scope: Scope,
                       images: ofloat,
                       contrast_factor: ofloat): AdjustContrastv2 {.header:"../../ops/image/image.h", importcpp:"AdjustContrastv2(*#, #, #)", constructor.}
...
type AdjustHue* {.header:"../../ops/image/image.h", importcpp:"AdjustHue/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat

proc iiadjustHue(scope: Scope,
                images: ofloat,
                delta: ofloat): AdjustHue {.header:"../../ops/image/image.h", importcpp:"AdjustHue(*#, #, #)", constructor.}
...
type AdjustSaturation* {.header:"../../ops/image/image.h", importcpp:"AdjustSaturation/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat

proc iiadjustSaturation(scope: Scope,
                       images: ofloat,
                       scale: ofloat): AdjustSaturation {.header:"../../ops/image/image.h", importcpp:"AdjustSaturation(*#, #, #)", constructor.}
...
type CropAndResize* {.header:"../../ops/image/image.h", importcpp:"CropAndResize/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iicropAndResize(scope: Scope,
                    ...
                    nmethod: cstring): CropAndResize {.header:"../../ops/image/image.h", importcpp:"CropAndResize(*#, #, #, #, #, #, tensorflow::string(#))", constructor.}
...
type CropAndResizeGradImage*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"CropAndResizeGradImage/*'0*/".} = object
...
proc iicropAndResizeGradImage[oT: oall](scope: Scope,
                             ...
                             T: DType,
                             nmethod: cstring,
                             explicitT: type(oT)): CropAndResizeGradImage[oT] {.header:"../../ops/image/image.h", importcpp:"CropAndResizeGradImage(*#, #, #, #, #, #, tensorflow::string(#))", constructor.}
...
type DecodeAndCropJpeg* {.header:"../../ops/image/image.h", importcpp:"DecodeAndCropJpeg/*'0*/".} = object
...
proc iidecodeAndCropJpeg(scope: Scope,
                        ...
                        acceptable_fraction: float32): DecodeAndCropJpeg {.header:"../../ops/image/image.h", importcpp:"DecodeAndCropJpeg(*#, #, #, tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type DecodeBmp* {.header:"../../ops/image/image.h", importcpp:"DecodeBmp/*'0*/".} = object
  operation*: Operation[ouint8]
  output*: ouint8

proc iidecodeBmp(scope: Scope,
                contents: ostring,
                channels: int64): DecodeBmp {.header:"../../ops/image/image.h", importcpp:"DecodeBmp(*#, #, #)", constructor.}
...
type DecodeCSV*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"DecodeCSV/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iidecodeCSV[oT: oall](scope: Scope,
                ...
                field_delim: cstring,
                use_quote_delim: bool): DecodeCSV[oT] {.header:"../../ops/image/image.h", importcpp:"DecodeCSV(*#, #, #, #, tensorflow::string(#), #, tensorflow::string(#), #)", constructor.}
...
type DecodeGif* {.header:"../../ops/image/image.h", importcpp:"DecodeGif/*'0*/".} = object
  operation*: Operation[ouint8]
  output*: ouint8

proc iidecodeGif(scope: Scope,
                contents: ostring): DecodeGif {.header:"../../ops/image/image.h", importcpp:"DecodeGif(*#, #)", constructor.}
...
type DecodeJpeg* {.header:"../../ops/image/image.h", importcpp:"DecodeJpeg/*'0*/".} = object
  operation*: Operation[ouint8]
  output*: ouint8
...
proc iidecodeJpeg(scope: Scope,
                 ...
                 fancy_upscaling: bool,
                 try_recover_truncated: bool,
                 acceptable_fraction: float32): DecodeJpeg {.header:"../../ops/image/image.h", importcpp:"DecodeJpeg(*#, #, tensorflow::string(#), #, #, #, #, #)", constructor.}
...
type DecodePng*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"DecodePng/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidecodePng[oT: oall](scope: Scope,
                ...
                channels: int64,
                dtype: DType,
                explicitT: type(oT)): DecodePng[oT] {.header:"../../ops/image/image.h", importcpp:"DecodePng(*#, #, #, #)", constructor.}
...
type DecodeRaw*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"DecodeRaw/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidecodeRaw[oT: oall](scope: Scope,
                ...
                out_type: DType,
                little_endian: bool,
                explicitT: type(oT)): DecodeRaw[oT] {.header:"../../ops/image/image.h", importcpp:"DecodeRaw(*#, #, #, #)", constructor.}
...
type DrawBoundingBoxes*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"DrawBoundingBoxes/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iidrawBoundingBoxes[oT: oall](scope: Scope,
                        images: oT,
                        boxes: ofloat,
                        T: DType): DrawBoundingBoxes[oT] {.header:"../../ops/image/image.h", importcpp:"DrawBoundingBoxes(*#, #, #, #)", constructor.}
...
type EncodeJpeg* {.header:"../../ops/image/image.h", importcpp:"EncodeJpeg/*'0*/".} = object
...
proc iiencodeJpeg(scope: Scope,
                 ...
                 x_density: int64,
                 y_density: int64): EncodeJpeg {.header:"../../ops/image/image.h", importcpp:"EncodeJpeg(*#, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #, tensorflow::string(#), #, #)", constructor.}
...
type EncodePng* {.header:"../../ops/image/image.h", importcpp:"EncodePng/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iiencodePng(scope: Scope,
                image: EncodePngT,
                compression: int64): EncodePng {.header:"../../ops/image/image.h", importcpp:"EncodePng(*#, #, #)", constructor.}
...
type ExtractGlimpse* {.header:"../../ops/image/image.h", importcpp:"ExtractGlimpse/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iiextractGlimpse(scope: Scope,
                     ...
                     centered: bool,
                     normalized: bool,
                     uniform_noise: bool): ExtractGlimpse {.header:"../../ops/image/image.h", importcpp:"ExtractGlimpse(*#, #, #, #, #, #, #)", constructor.}
...
type ExtractImagePatches*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"ExtractImagePatches/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiextractImagePatches[oT: oall](scope: Scope,
                          ...
                          padding: cstring,
                          T: DType): ExtractImagePatches[oT] {.header:"../../ops/image/image.h", importcpp:"ExtractImagePatches(*#, #, #, #, #, tensorflow::string(#), #)", constructor.}
...
type ExtractJpegShape*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"ExtractJpegShape/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiextractJpegShape[oT: oall](scope: Scope,
                       contents: ostring,
                       output_type: DType,
                       explicitT: type(oT)): ExtractJpegShape[oT] {.header:"../../ops/image/image.h", importcpp:"ExtractJpegShape(*#, #, #)", constructor.}
...
type HSVToRGB*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"HSVToRGB/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iihSVToRGB[oT: oall](scope: Scope,
               images: oT,
               T: DType): HSVToRGB[oT] {.header:"../../ops/image/image.h", importcpp:"HSVToRGB(*#, #, #)", constructor.}
...
type NonMaxSuppression* {.header:"../../ops/image/image.h", importcpp:"NonMaxSuppression/*'0*/".} = object
...
proc iinonMaxSuppression(scope: Scope,
                        ...
                        iou_threshold: float32): NonMaxSuppression {.header:"../../ops/image/image.h", importcpp:"NonMaxSuppression(*#, #, #, #, #)", constructor.}
...
type NonMaxSuppressionV2* {.header:"../../ops/image/image.h", importcpp:"NonMaxSuppressionV2/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32
...
proc iinonMaxSuppressionV2(scope: Scope,
                          ...
                          max_output_size: oint32,
                          iou_threshold: ofloat): NonMaxSuppressionV2 {.header:"../../ops/image/image.h", importcpp:"NonMaxSuppressionV2(*#, #, #, #, #)", constructor.}
...
type QuantizedResizeBilinear*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"QuantizedResizeBilinear/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiquantizedResizeBilinear[oT: oall](scope: Scope,
                              ...
                              max: ofloat,
                              T: DType,
                              align_corners: bool): QuantizedResizeBilinear[oT] {.header:"../../ops/image/image.h", importcpp:"QuantizedResizeBilinear(*#, #, #, #, #, #, #)", constructor.}
...
type RGBToHSV*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"RGBToHSV/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT

proc iirGBToHSV[oT: oall](scope: Scope,
               images: oT,
               T: DType): RGBToHSV[oT] {.header:"../../ops/image/image.h", importcpp:"RGBToHSV(*#, #, #)", constructor.}
...
type RandomCrop*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"RandomCrop/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iirandomCrop[oT: oall](scope: Scope,
                 ...
                 T: DType,
                 seed: int64,
                 seed2: int64): RandomCrop[oT] {.header:"../../ops/image/image.h", importcpp:"RandomCrop(*#, #, #, #, #, #)", constructor.}
...
type ResizeArea* {.header:"../../ops/image/image.h", importcpp:"ResizeArea/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iiresizeArea(scope: Scope,
                 images: ResizeAreaT,
                 size: oint32,
                 align_corners: bool): ResizeArea {.header:"../../ops/image/image.h", importcpp:"ResizeArea(*#, #, #, #)", constructor.}
...
type ResizeBicubic* {.header:"../../ops/image/image.h", importcpp:"ResizeBicubic/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iiresizeBicubic(scope: Scope,
                    ...
                    size: oint32,
                    align_corners: bool): ResizeBicubic {.header:"../../ops/image/image.h", importcpp:"ResizeBicubic(*#, #, #, #)", constructor.}
...
type ResizeBicubicGrad*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"ResizeBicubicGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiresizeBicubicGrad[oT: oall](scope: Scope,
                        ...
                        original_image: oT,
                        T: DType,
                        align_corners: bool): ResizeBicubicGrad[oT] {.header:"../../ops/image/image.h", importcpp:"ResizeBicubicGrad(*#, #, #, #, #)", constructor.}
...
type ResizeBilinear* {.header:"../../ops/image/image.h", importcpp:"ResizeBilinear/*'0*/".} = object
  operation*: Operation[ofloat]
  output*: ofloat
...
proc iiresizeBilinear(scope: Scope,
                     ...
                     size: oint32,
                     align_corners: bool): ResizeBilinear {.header:"../../ops/image/image.h", importcpp:"ResizeBilinear(*#, #, #, #)", constructor.}
...
type ResizeBilinearGrad*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"ResizeBilinearGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiresizeBilinearGrad[oT: oall](scope: Scope,
                         ...
                         original_image: oT,
                         T: DType,
                         align_corners: bool): ResizeBilinearGrad[oT] {.header:"../../ops/image/image.h", importcpp:"ResizeBilinearGrad(*#, #, #, #, #)", constructor.}
...
type ResizeNearestNeighbor*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"ResizeNearestNeighbor/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiresizeNearestNeighbor[oT: oall](scope: Scope,
                            ...
                            size: oint32,
                            T: DType,
                            align_corners: bool): ResizeNearestNeighbor[oT] {.header:"../../ops/image/image.h", importcpp:"ResizeNearestNeighbor(*#, #, #, #, #)", constructor.}
...
type ResizeNearestNeighborGrad*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"ResizeNearestNeighborGrad/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iiresizeNearestNeighborGrad[oT: oall](scope: Scope,
                                ...
                                size: oint32,
                                T: DType,
                                align_corners: bool): ResizeNearestNeighborGrad[oT] {.header:"../../ops/image/image.h", importcpp:"ResizeNearestNeighborGrad(*#, #, #, #, #)", constructor.}
...
type SampleDistortedBoundingBox*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"SampleDistortedBoundingBox/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisampleDistortedBoundingBox[oT: oall](scope: Scope,
                                 ...
                                 max_attempts: int64,
                                 use_image_if_no_bounding_boxes: bool): SampleDistortedBoundingBox[oT] {.header:"../../ops/image/image.h", importcpp:"SampleDistortedBoundingBox(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
...
type SampleDistortedBoundingBoxV2*[oT:oall] {.header:"../../ops/image/image.h", importcpp:"SampleDistortedBoundingBoxV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iisampleDistortedBoundingBoxV2[oT: oall](scope: Scope,
                                   ...
                                   area_range: ArraySlice[float32],
                                   max_attempts: int64,
                                   use_image_if_no_bounding_boxes: bool): SampleDistortedBoundingBoxV2[oT] {.header:"../../ops/image/image.h", importcpp:"SampleDistortedBoundingBoxV2(*#, #, #, #, #, #, #, #, #, #, #)", constructor.}
