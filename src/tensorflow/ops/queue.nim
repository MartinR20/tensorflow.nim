...
{.compile:"../../ops/queue/queue.cc".}


type FIFOQueue* {.header:"../../ops/queue/queue.h", importcpp:"FIFOQueue/*'0*/".} = object
...
proc iifIFOQueue(scope: Scope,
                ...
                container: cstring,
                shared_name: cstring,
                capacity: int64): FIFOQueue {.header:"../../ops/queue/queue.h", importcpp:"FIFOQueue(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type FIFOQueueV2* {.header:"../../ops/queue/queue.h", importcpp:"FIFOQueueV2/*'0*/".} = object
...
proc iifIFOQueueV2(scope: Scope,
                  ...
                  container: cstring,
                  shared_name: cstring,
                  capacity: int64): FIFOQueueV2 {.header:"../../ops/queue/queue.h", importcpp:"FIFOQueueV2(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type FakeQueue* {.header:"../../ops/queue/queue.h", importcpp:"FakeQueue/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring

proc iifakeQueue(scope: Scope,
                resource: oresource): FakeQueue {.header:"../../ops/queue/queue.h", importcpp:"FakeQueue(*#, #)", constructor.}
...
type PaddingFIFOQueue* {.header:"../../ops/queue/queue.h", importcpp:"PaddingFIFOQueue/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iipaddingFIFOQueue(scope: Scope,
                       ...
                       container: cstring,
                       shared_name: cstring,
                       capacity: int64): PaddingFIFOQueue {.header:"../../ops/queue/queue.h", importcpp:"PaddingFIFOQueue(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type PaddingFIFOQueueV2* {.header:"../../ops/queue/queue.h", importcpp:"PaddingFIFOQueueV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iipaddingFIFOQueueV2(scope: Scope,
                         ...
                         container: cstring,
                         shared_name: cstring,
                         capacity: int64): PaddingFIFOQueueV2 {.header:"../../ops/queue/queue.h", importcpp:"PaddingFIFOQueueV2(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type PriorityQueue* {.header:"../../ops/queue/queue.h", importcpp:"PriorityQueue/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iipriorityQueue(scope: Scope,
                    ...
                    container: cstring,
                    shared_name: cstring,
                    capacity: int64): PriorityQueue {.header:"../../ops/queue/queue.h", importcpp:"PriorityQueue(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type PriorityQueueV2* {.header:"../../ops/queue/queue.h", importcpp:"PriorityQueueV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iipriorityQueueV2(scope: Scope,
                      ...
                      container: cstring,
                      shared_name: cstring,
                      capacity: int64): PriorityQueueV2 {.header:"../../ops/queue/queue.h", importcpp:"PriorityQueueV2(*#, #, #, tensorflow::string(#), tensorflow::string(#), #)", constructor.}
...
type QueueClose*{.header:"../../ops/queue/queue.h", importcpp:"QueueClose/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiqueueClose(scope: Scope,
                 handle: ostring,
                 cancel_pending_enqueues: bool): QueueClose {.header:"../../ops/queue/queue.h", importcpp:"QueueClose(*#, #, #)", constructor.}
...
type QueueCloseV2*{.header:"../../ops/queue/queue.h", importcpp:"QueueCloseV2/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iiqueueCloseV2(scope: Scope,
                   handle: oresource,
                   cancel_pending_enqueues: bool): QueueCloseV2 {.header:"../../ops/queue/queue.h", importcpp:"QueueCloseV2(*#, #, #)", constructor.}
...
type QueueDequeue*[oT:oall] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeue/*'0*/".} = object
...
proc iiqueueDequeue[oT: oall](scope: Scope,
                   ...
                   component_types: ArraySlice[DType],
                   timeout_ms: int64,
                   explicitT: type(oT)): QueueDequeue[oT] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeue(*#, #, #, #)", constructor.}
...
type QueueDequeueMany*[oT:oall] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueMany/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiqueueDequeueMany[oT: oall](scope: Scope,
                       ...
                       component_types: ArraySlice[DType],
                       timeout_ms: int64,
                       explicitT: type(oT)): QueueDequeueMany[oT] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueMany(*#, #, #, #, #)", constructor.}
...
type QueueDequeueManyV2*[oT:oall] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueManyV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiqueueDequeueManyV2[oT: oall](scope: Scope,
                         ...
                         component_types: ArraySlice[DType],
                         timeout_ms: int64,
                         explicitT: type(oT)): QueueDequeueManyV2[oT] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueManyV2(*#, #, #, #, #)", constructor.}
...
type QueueDequeueUpTo*[oT:oall] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueUpTo/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiqueueDequeueUpTo[oT: oall](scope: Scope,
                       ...
                       component_types: ArraySlice[DType],
                       timeout_ms: int64,
                       explicitT: type(oT)): QueueDequeueUpTo[oT] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueUpTo(*#, #, #, #, #)", constructor.}
...
type QueueDequeueUpToV2*[oT:oall] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueUpToV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiqueueDequeueUpToV2[oT: oall](scope: Scope,
                         ...
                         component_types: ArraySlice[DType],
                         timeout_ms: int64,
                         explicitT: type(oT)): QueueDequeueUpToV2[oT] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueUpToV2(*#, #, #, #, #)", constructor.}
...
type QueueDequeueV2*[oT:oall] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: olist[oT]
...
proc iiqueueDequeueV2[oT: oall](scope: Scope,
                     ...
                     component_types: ArraySlice[DType],
                     timeout_ms: int64,
                     explicitT: type(oT)): QueueDequeueV2[oT] {.header:"../../ops/queue/queue.h", importcpp:"QueueDequeueV2(*#, #, #, #)", constructor.}
...
type QueueEnqueue*{.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueue/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiqueueEnqueue(scope: Scope,
                   ...
                   timeout_ms: int64): QueueEnqueue {.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueue(*#, #, #, #, #)", constructor.}
...
type QueueEnqueueMany*{.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueueMany/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiqueueEnqueueMany(scope: Scope,
                       ...
                       components: olist[oall],
                       Tcomponents: ArraySlice[DType],
                       timeout_ms: int64): QueueEnqueueMany {.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueueMany(*#, #, #, #, #)", constructor.}
...
type QueueEnqueueManyV2*{.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueueManyV2/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiqueueEnqueueManyV2(scope: Scope,
                         ...
                         components: olist[oall],
                         Tcomponents: ArraySlice[DType],
                         timeout_ms: int64): QueueEnqueueManyV2 {.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueueManyV2(*#, #, #, #, #)", constructor.}
...
type QueueEnqueueV2*{.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueueV2/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iiqueueEnqueueV2(scope: Scope,
                     ...
                     components: olist[oall],
                     Tcomponents: ArraySlice[DType],
                     timeout_ms: int64): QueueEnqueueV2 {.header:"../../ops/queue/queue.h", importcpp:"QueueEnqueueV2(*#, #, #, #, #)", constructor.}
...
type QueueIsClosed* {.header:"../../ops/queue/queue.h", importcpp:"QueueIsClosed/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iiqueueIsClosed(scope: Scope,
                    handle: ostring): QueueIsClosed {.header:"../../ops/queue/queue.h", importcpp:"QueueIsClosed(*#, #)", constructor.}
...
type QueueIsClosedV2* {.header:"../../ops/queue/queue.h", importcpp:"QueueIsClosedV2/*'0*/".} = object
  operation*: Operation[obool]
  output*: obool

proc iiqueueIsClosedV2(scope: Scope,
                      handle: oresource): QueueIsClosedV2 {.header:"../../ops/queue/queue.h", importcpp:"QueueIsClosedV2(*#, #)", constructor.}
...
type QueueSize* {.header:"../../ops/queue/queue.h", importcpp:"QueueSize/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iiqueueSize(scope: Scope,
                handle: ostring): QueueSize {.header:"../../ops/queue/queue.h", importcpp:"QueueSize(*#, #)", constructor.}
...
type QueueSizeV2* {.header:"../../ops/queue/queue.h", importcpp:"QueueSizeV2/*'0*/".} = object
  operation*: Operation[oint32]
  output*: oint32

proc iiqueueSizeV2(scope: Scope,
                  handle: oresource): QueueSizeV2 {.header:"../../ops/queue/queue.h", importcpp:"QueueSizeV2(*#, #)", constructor.}
...
type RandomShuffleQueue* {.header:"../../ops/queue/queue.h", importcpp:"RandomShuffleQueue/*'0*/".} = object
  operation*: Operation[ostring]
  output*: ostring
...
proc iirandomShuffleQueue(scope: Scope,
                         ...
                         seed: int64,
                         seed2: int64): RandomShuffleQueue {.header:"../../ops/queue/queue.h", importcpp:"RandomShuffleQueue(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #)", constructor.}
...
type RandomShuffleQueueV2* {.header:"../../ops/queue/queue.h", importcpp:"RandomShuffleQueueV2/*'0*/".} = object
  operation*: Operation[oresource]
  output*: oresource
...
proc iirandomShuffleQueueV2(scope: Scope,
                           ...
                           min_after_dequeue: int64,
                           seed: int64,
                           seed2: int64): RandomShuffleQueueV2 {.header:"../../ops/queue/queue.h", importcpp:"RandomShuffleQueueV2(*#, #, #, tensorflow::string(#), tensorflow::string(#), #, #, #, #)", constructor.}
