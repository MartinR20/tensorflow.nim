...
{.compile:"../../ops/lookup/lookup.cc".}


type LookupTableExport*[oT:oall] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableExport/*'0*/".} = object
...
proc iilookupTableExport[oT: oall](scope: Scope,
                        ...
                        Tkeys: DType,
                        Tvalues: DType,
                        explicitT: type(oT)): LookupTableExport[oT] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableExport(*#, #, #, #)", constructor.}
...
type LookupTableExportV2*[oT:oall] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableExportV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iilookupTableExportV2[oT: oall](scope: Scope,
                          ...
                          Tkeys: DType,
                          Tvalues: DType,
                          explicitT: type(oT)): LookupTableExportV2[oT] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableExportV2(*#, #, #, #)", constructor.}
...
type LookupTableFind*[oT:oall] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableFind/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iilookupTableFind[oT: oall](scope: Scope,
                      ...
                      default_value: oT,
                      Tout: DType): LookupTableFind[oT] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableFind(*#, #, #, #, #)", constructor.}
...
type LookupTableFindV2*[oT:oall] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableFindV2/*'0*/".} = object
  operation*: Operation[oT]
  output*: oT
...
proc iilookupTableFindV2[oT: oall](scope: Scope,
                        ...
                        default_value: oT,
                        Tout: DType): LookupTableFindV2[oT] {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableFindV2(*#, #, #, #, #)", constructor.}
...
type LookupTableImport*{.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableImport/*'0*/".} = object
...
proc iilookupTableImport(scope: Scope,
                        ...
                        values: LookupTableImportTout): LookupTableImport {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableImport(*#, #, #, #)", constructor.}
...
type LookupTableImportV2*{.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableImportV2/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iilookupTableImportV2(scope: Scope,
                          ...
                          values: LookupTableImportV2Tout): LookupTableImportV2 {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableImportV2(*#, #, #, #)", constructor.}
...
type LookupTableInsert*{.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableInsert/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iilookupTableInsert(scope: Scope,
                        ...
                        values: LookupTableInsertTout): LookupTableInsert {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableInsert(*#, #, #, #)", constructor.}
...
type LookupTableInsertV2*{.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableInsertV2/*'0*/".} = object
  operation*: Operation[oinvalid]
...
proc iilookupTableInsertV2(scope: Scope,
                          ...
                          values: LookupTableInsertV2Tout): LookupTableInsertV2 {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableInsertV2(*#, #, #, #)", constructor.}
...
type LookupTableRemoveV2*{.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableRemoveV2/*'0*/".} = object
  operation*: Operation[oinvalid]


proc iilookupTableRemoveV2(scope: Scope,
                          table_handle: oresource,
                          keys: LookupTableRemoveV2Tin): LookupTableRemoveV2 {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableRemoveV2(*#, #, #)", constructor.}
...
type LookupTableSize* {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableSize/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iilookupTableSize(scope: Scope,
                      table_handle: ostring): LookupTableSize {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableSize(*#, #)", constructor.}
...
type LookupTableSizeV2* {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableSizeV2/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64

proc iilookupTableSizeV2(scope: Scope,
                        table_handle: oresource): LookupTableSizeV2 {.header:"../../ops/lookup/lookup.h", importcpp:"LookupTableSizeV2(*#, #)", constructor.}
