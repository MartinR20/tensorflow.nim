...
type RaggedRange* {.header:"/Users/martin//.nimble/pkgs/tensorflow-0.1.0/tensorflow/ops/ragged/ragged.h", importcpp:"RaggedRange/*'0*/".} = object
...
proc iiraggedRange(scope: Scope,
                  starts: RaggedRangeT,
                  limits: RaggedRangeT,
                  deltas: RaggedRangeT): RaggedRange {.header:"/Users/martin//.nimble/pkgs/tensorflow-0.1.0/tensorflow/ops/ragged/ragged.h", importcpp:"RaggedRange(*#, #, #, #)", constructor.}
...
type RaggedTensorToSparse* {.header:"/Users/martin//.nimble/pkgs/tensorflow-0.1.0/tensorflow/ops/ragged/ragged.h", importcpp:"RaggedTensorToSparse/*'0*/".} = object
  operation*: Operation[oint64]
  output*: oint64
